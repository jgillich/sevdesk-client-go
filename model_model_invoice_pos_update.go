...
// checks if the ModelInvoicePosUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelInvoicePosUpdate{}

// ModelInvoicePosUpdate Invoice position model
type ModelInvoicePosUpdate struct {
	...
	Invoice NullableModelInvoicePosUpdateInvoice `json:"invoice,omitempty"`
	...
	Unity *ModelInvoicePosUnity `json:"unity,omitempty"`
	SevClient *ModelInvoicePosSevClient `json:"sevClient,omitempty"`
...
func (o *ModelInvoicePosUpdate) GetInvoice() ModelInvoicePosUpdateInvoice {
	if o == nil || IsNil(o.Invoice.Get()) {
		var ret ModelInvoicePosUpdateInvoice
		return ret
	}
...
// SetInvoice gets a reference to the given NullableModelInvoicePosUpdateInvoice and assigns it to the Invoice field.
...
func (o *ModelInvoicePosUpdate) SetInvoiceNil() {
	o.Invoice.Set(nil)
}
...
func (o *ModelInvoicePosUpdate) SetQuantityNil() {
	o.Quantity.Set(nil)
}
...
func (o *ModelInvoicePosUpdate) SetPriceNil() {
	o.Price.Set(nil)
}
...
func (o *ModelInvoicePosUpdate) SetNameNil() {
	o.Name.Set(nil)
}
...
// SetUnity gets a reference to the given ModelInvoicePosUnity and assigns it to the Unity field.
...
func (o *ModelInvoicePosUpdate) GetSevClient() ModelInvoicePosSevClient {
	if o == nil || IsNil(o.SevClient) {
		var ret ModelInvoicePosSevClient
		return ret
	}
	return *o.SevClient
}
...
// SetSevClient gets a reference to the given ModelInvoicePosSevClient and assigns it to the SevClient field.
...
func (o *ModelInvoicePosUpdate) SetPositionNumberNil() {
...
func (o *ModelInvoicePosUpdate) SetTextNil() {
	o.Text.Set(nil)
}
...
func (o *ModelInvoicePosUpdate) SetDiscountNil() {
	o.Discount.Set(nil)
}
...
func (o *ModelInvoicePosUpdate) SetTaxRateNil() {
	o.TaxRate.Set(nil)
}
...
func (o *ModelInvoicePosUpdate) SetSumDiscountNil() {
...
func (o *ModelInvoicePosUpdate) SetSumNetAccountingNil() {
...
func (o *ModelInvoicePosUpdate) SetSumTaxAccountingNil() {
...
func (o *ModelInvoicePosUpdate) SetSumGrossAccountingNil() {
...
func (o *ModelInvoicePosUpdate) SetPriceNetNil() {
	o.PriceNet.Set(nil)
}
...
func (o *ModelInvoicePosUpdate) SetPriceGrossNil() {
...
func (o *ModelInvoicePosUpdate) SetPriceTaxNil() {
	o.PriceTax.Set(nil)
}
...
func (o ModelInvoicePosUpdate) MarshalJSON() ([]byte, error) {
...
func (o ModelInvoicePosUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableModelInvoicePosUpdate struct {
	value *ModelInvoicePosUpdate
	isSet bool
}

func (v NullableModelInvoicePosUpdate) Get() *ModelInvoicePosUpdate {
	return v.value
}

func (v *NullableModelInvoicePosUpdate) Set(val *ModelInvoicePosUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableModelInvoicePosUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableModelInvoicePosUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelInvoicePosUpdate(val *ModelInvoicePosUpdate) *NullableModelInvoicePosUpdate {
	return &NullableModelInvoicePosUpdate{value: val, isSet: true}
}

func (v NullableModelInvoicePosUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelInvoicePosUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
