...
// checks if the ReportOrderSevQueryParameterFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportOrderSevQueryParameterFilter{}

// ReportOrderSevQueryParameterFilter struct for ReportOrderSevQueryParameterFilter
type ReportOrderSevQueryParameterFilter struct {
	...
	Contact *ReportOrderSevQueryParameterFilterContact `json:"contact,omitempty"`
...
func NewReportOrderSevQueryParameterFilter() *ReportOrderSevQueryParameterFilter {
	this := ReportOrderSevQueryParameterFilter{}
	return &this
}
...
func (o *ReportOrderSevQueryParameterFilter) GetContact() ReportOrderSevQueryParameterFilterContact {
	if o == nil || IsNil(o.Contact) {
		var ret ReportOrderSevQueryParameterFilterContact
		return ret
	}
	return *o.Contact
}
...
// SetContact gets a reference to the given ReportOrderSevQueryParameterFilterContact and assigns it to the Contact field.
...
func (o ReportOrderSevQueryParameterFilter) MarshalJSON() ([]byte, error) {
...
func (o ReportOrderSevQueryParameterFilter) ToMap() (map[string]interface{}, error) {
...
type NullableReportOrderSevQueryParameterFilter struct {
	value *ReportOrderSevQueryParameterFilter
	isSet bool
}

func (v NullableReportOrderSevQueryParameterFilter) Get() *ReportOrderSevQueryParameterFilter {
	return v.value
}

func (v *NullableReportOrderSevQueryParameterFilter) Set(val *ReportOrderSevQueryParameterFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableReportOrderSevQueryParameterFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableReportOrderSevQueryParameterFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportOrderSevQueryParameterFilter(val *ReportOrderSevQueryParameterFilter) *NullableReportOrderSevQueryParameterFilter {
	return &NullableReportOrderSevQueryParameterFilter{value: val, isSet: true}
}

func (v NullableReportOrderSevQueryParameterFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportOrderSevQueryParameterFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
