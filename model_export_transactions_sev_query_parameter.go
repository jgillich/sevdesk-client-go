...
// checks if the ExportTransactionsSevQueryParameter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportTransactionsSevQueryParameter{}

// ExportTransactionsSevQueryParameter struct for ExportTransactionsSevQueryParameter
type ExportTransactionsSevQueryParameter struct {
	// Limit export
	...
	Filter *ExportTransactionsSevQueryParameterFilter `json:"filter,omitempty"`
}
...
func NewExportTransactionsSevQueryParameter(modelName interface{}, objectName interface{}) *ExportTransactionsSevQueryParameter {
	this := ExportTransactionsSevQueryParameter{}
...
func (o *ExportTransactionsSevQueryParameter) GetFilter() ExportTransactionsSevQueryParameterFilter {
	if o == nil || IsNil(o.Filter) {
		var ret ExportTransactionsSevQueryParameterFilter
		return ret
	}
	return *o.Filter
}
...
// SetFilter gets a reference to the given ExportTransactionsSevQueryParameterFilter and assigns it to the Filter field.
func (o *ExportTransactionsSevQueryParameter) SetFilter(v ExportTransactionsSevQueryParameterFilter) {
	o.Filter = &v
}

func (o ExportTransactionsSevQueryParameter) MarshalJSON() ([]byte, error) {
...
func (o ExportTransactionsSevQueryParameter) ToMap() (map[string]interface{}, error) {
...
type NullableExportTransactionsSevQueryParameter struct {
	value *ExportTransactionsSevQueryParameter
	isSet bool
}

func (v NullableExportTransactionsSevQueryParameter) Get() *ExportTransactionsSevQueryParameter {
	return v.value
}

func (v *NullableExportTransactionsSevQueryParameter) Set(val *ExportTransactionsSevQueryParameter) {
	v.value = val
	v.isSet = true
}

func (v NullableExportTransactionsSevQueryParameter) IsSet() bool {
	return v.isSet
}

func (v *NullableExportTransactionsSevQueryParameter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportTransactionsSevQueryParameter(val *ExportTransactionsSevQueryParameter) *NullableExportTransactionsSevQueryParameter {
	return &NullableExportTransactionsSevQueryParameter{value: val, isSet: true}
}

func (v NullableExportTransactionsSevQueryParameter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportTransactionsSevQueryParameter) UnmarshalJSON(src []byte) error {
	v.isSet = true
