...
// checks if the ModelCheckAccountTransactionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelCheckAccountTransactionResponse{}
...
type ModelCheckAccountTransactionResponse struct {
	...
	SevClient *ModelCheckAccountTransactionResponseSevClient `json:"sevClient,omitempty"`
	...
	CheckAccount *ModelCheckAccountTransactionResponseCheckAccount `json:"checkAccount,omitempty"`
	...
	SourceTransaction *ModelCheckAccountTransactionResponseSourceTransaction `json:"sourceTransaction,omitempty"`
	TargetTransaction *ModelCheckAccountTransactionResponseTargetTransaction `json:"targetTransaction,omitempty"`
}
...
func NewModelCheckAccountTransactionResponse() *ModelCheckAccountTransactionResponse {
	this := ModelCheckAccountTransactionResponse{}
	return &this
}
...
func (o *ModelCheckAccountTransactionResponse) GetSevClient() ModelCheckAccountTransactionResponseSevClient {
	if o == nil || IsNil(o.SevClient) {
		var ret ModelCheckAccountTransactionResponseSevClient
		return ret
	}
	return *o.SevClient
}
...
// SetSevClient gets a reference to the given ModelCheckAccountTransactionResponseSevClient and assigns it to the SevClient field.
...
// GetPayeePayerName returns the PayeePayerName field value if set, zero value otherwise.
func (o *ModelCheckAccountTransactionResponse) GetPayeePayerName() string {
	if o == nil || IsNil(o.PayeePayerName) {
		var ret string
		return ret
	}
...
// SetPayeePayerName gets a reference to the given string and assigns it to the PayeePayerName field.
...
func (o *ModelCheckAccountTransactionResponse) GetCheckAccount() ModelCheckAccountTransactionResponseCheckAccount {
	if o == nil || IsNil(o.CheckAccount) {
		var ret ModelCheckAccountTransactionResponseCheckAccount
		return ret
	}
...
// SetCheckAccount gets a reference to the given ModelCheckAccountTransactionResponseCheckAccount and assigns it to the CheckAccount field.
...
// GetSourceTransaction returns the SourceTransaction field value if set, zero value otherwise.
func (o *ModelCheckAccountTransactionResponse) GetSourceTransaction() ModelCheckAccountTransactionResponseSourceTransaction {
	if o == nil || IsNil(o.SourceTransaction) {
		var ret ModelCheckAccountTransactionResponseSourceTransaction
		return ret
	}
...
func (o *ModelCheckAccountTransactionResponse) GetSourceTransactionOk() (*ModelCheckAccountTransactionResponseSourceTransaction, bool) {
	...
	return o.SourceTransaction, true
}
...
// SetSourceTransaction gets a reference to the given ModelCheckAccountTransactionResponseSourceTransaction and assigns it to the SourceTransaction field.
func (o *ModelCheckAccountTransactionResponse) SetSourceTransaction(v ModelCheckAccountTransactionResponseSourceTransaction) {
	o.SourceTransaction = &v
}

// GetTargetTransaction returns the TargetTransaction field value if set, zero value otherwise.
func (o *ModelCheckAccountTransactionResponse) GetTargetTransaction() ModelCheckAccountTransactionResponseTargetTransaction {
	if o == nil || IsNil(o.TargetTransaction) {
		var ret ModelCheckAccountTransactionResponseTargetTransaction
		return ret
	}
	return *o.TargetTransaction
}
...
func (o *ModelCheckAccountTransactionResponse) GetTargetTransactionOk() (*ModelCheckAccountTransactionResponseTargetTransaction, bool) {
	...
	return o.TargetTransaction, true
}
...
// SetTargetTransaction gets a reference to the given ModelCheckAccountTransactionResponseTargetTransaction and assigns it to the TargetTransaction field.
func (o *ModelCheckAccountTransactionResponse) SetTargetTransaction(v ModelCheckAccountTransactionResponseTargetTransaction) {
	o.TargetTransaction = &v
}

func (o ModelCheckAccountTransactionResponse) MarshalJSON() ([]byte, error) {
...
func (o ModelCheckAccountTransactionResponse) ToMap() (map[string]interface{}, error) {
	...
	// skip: valueDate is readOnly
	// skip: entryDate is readOnly
	// skip: paymtPurpose is readOnly
	// skip: amount is readOnly
	// skip: payeePayerName is readOnly
	if !IsNil(o.CheckAccount) {
		toSerialize["checkAccount"] = o.CheckAccount
	}
	// skip: status is readOnly
	// skip: enshrined is readOnly
	if !IsNil(o.SourceTransaction) {
		toSerialize["sourceTransaction"] = o.SourceTransaction
	}
	if !IsNil(o.TargetTransaction) {
		toSerialize["targetTransaction"] = o.TargetTransaction
	}
	return toSerialize, nil
}

type NullableModelCheckAccountTransactionResponse struct {
	value *ModelCheckAccountTransactionResponse
	isSet bool
}

func (v NullableModelCheckAccountTransactionResponse) Get() *ModelCheckAccountTransactionResponse {
	return v.value
}

func (v *NullableModelCheckAccountTransactionResponse) Set(val *ModelCheckAccountTransactionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableModelCheckAccountTransactionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableModelCheckAccountTransactionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelCheckAccountTransactionResponse(val *ModelCheckAccountTransactionResponse) *NullableModelCheckAccountTransactionResponse {
	return &NullableModelCheckAccountTransactionResponse{value: val, isSet: true}
}

func (v NullableModelCheckAccountTransactionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelCheckAccountTransactionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
