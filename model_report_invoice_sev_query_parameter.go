...
// checks if the ReportInvoiceSevQueryParameter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportInvoiceSevQueryParameter{}

// ReportInvoiceSevQueryParameter struct for ReportInvoiceSevQueryParameter
type ReportInvoiceSevQueryParameter struct {
	// Limit export
	...
	Filter *ExportInvoiceSevQueryParameterFilter `json:"filter,omitempty"`
}
...
func NewReportInvoiceSevQueryParameter(modelName interface{}, objectName interface{}) *ReportInvoiceSevQueryParameter {
	this := ReportInvoiceSevQueryParameter{}
...
func (o *ReportInvoiceSevQueryParameter) GetFilter() ExportInvoiceSevQueryParameterFilter {
	if o == nil || IsNil(o.Filter) {
		var ret ExportInvoiceSevQueryParameterFilter
		return ret
	}
	return *o.Filter
}
...
// SetFilter gets a reference to the given ExportInvoiceSevQueryParameterFilter and assigns it to the Filter field.
func (o *ReportInvoiceSevQueryParameter) SetFilter(v ExportInvoiceSevQueryParameterFilter) {
	o.Filter = &v
}

func (o ReportInvoiceSevQueryParameter) MarshalJSON() ([]byte, error) {
...
func (o ReportInvoiceSevQueryParameter) ToMap() (map[string]interface{}, error) {
...
type NullableReportInvoiceSevQueryParameter struct {
	value *ReportInvoiceSevQueryParameter
	isSet bool
}

func (v NullableReportInvoiceSevQueryParameter) Get() *ReportInvoiceSevQueryParameter {
	return v.value
}

func (v *NullableReportInvoiceSevQueryParameter) Set(val *ReportInvoiceSevQueryParameter) {
	v.value = val
	v.isSet = true
}

func (v NullableReportInvoiceSevQueryParameter) IsSet() bool {
	return v.isSet
}

func (v *NullableReportInvoiceSevQueryParameter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportInvoiceSevQueryParameter(val *ReportInvoiceSevQueryParameter) *NullableReportInvoiceSevQueryParameter {
	return &NullableReportInvoiceSevQueryParameter{value: val, isSet: true}
}

func (v NullableReportInvoiceSevQueryParameter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportInvoiceSevQueryParameter) UnmarshalJSON(src []byte) error {
	v.isSet = true
