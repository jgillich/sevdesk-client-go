...
// checks if the BookInvoiceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BookInvoiceRequest{}

// BookInvoiceRequest struct for BookInvoiceRequest
type BookInvoiceRequest struct {
	...
	CheckAccountTransaction *BookInvoiceRequestCheckAccountTransaction `json:"checkAccountTransaction,omitempty"`
...
func (o *BookInvoiceRequest) GetCheckAccountTransaction() BookInvoiceRequestCheckAccountTransaction {
	if o == nil || IsNil(o.CheckAccountTransaction) {
		var ret BookInvoiceRequestCheckAccountTransaction
		return ret
	}
...
// SetCheckAccountTransaction gets a reference to the given BookInvoiceRequestCheckAccountTransaction and assigns it to the CheckAccountTransaction field.
...
func (o BookInvoiceRequest) MarshalJSON() ([]byte, error) {
...
func (o BookInvoiceRequest) ToMap() (map[string]interface{}, error) {
...
type NullableBookInvoiceRequest struct {
	value *BookInvoiceRequest
	isSet bool
}

func (v NullableBookInvoiceRequest) Get() *BookInvoiceRequest {
	return v.value
}

func (v *NullableBookInvoiceRequest) Set(val *BookInvoiceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBookInvoiceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBookInvoiceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBookInvoiceRequest(val *BookInvoiceRequest) *NullableBookInvoiceRequest {
	return &NullableBookInvoiceRequest{value: val, isSet: true}
}

func (v NullableBookInvoiceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBookInvoiceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
