...
// checks if the ModelContactCustomFieldSettingResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelContactCustomFieldSettingResponse{}
...
func NewModelContactCustomFieldSettingResponse() *ModelContactCustomFieldSettingResponse {
	this := ModelContactCustomFieldSettingResponse{}
	return &this
}
...
func (o ModelContactCustomFieldSettingResponse) MarshalJSON() ([]byte, error) {
...
func (o ModelContactCustomFieldSettingResponse) ToMap() (map[string]interface{}, error) {
...
type NullableModelContactCustomFieldSettingResponse struct {
	value *ModelContactCustomFieldSettingResponse
	isSet bool
}

func (v NullableModelContactCustomFieldSettingResponse) Get() *ModelContactCustomFieldSettingResponse {
	return v.value
}

func (v *NullableModelContactCustomFieldSettingResponse) Set(val *ModelContactCustomFieldSettingResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableModelContactCustomFieldSettingResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableModelContactCustomFieldSettingResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelContactCustomFieldSettingResponse(val *ModelContactCustomFieldSettingResponse) *NullableModelContactCustomFieldSettingResponse {
	return &NullableModelContactCustomFieldSettingResponse{value: val, isSet: true}
}

func (v NullableModelContactCustomFieldSettingResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelContactCustomFieldSettingResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
