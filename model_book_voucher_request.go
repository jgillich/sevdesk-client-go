...
// checks if the BookVoucherRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BookVoucherRequest{}

// BookVoucherRequest struct for BookVoucherRequest
type BookVoucherRequest struct {
	...
	CheckAccountTransaction *BookVoucherRequestCheckAccountTransaction `json:"checkAccountTransaction,omitempty"`
...
func (o *BookVoucherRequest) GetCheckAccountTransaction() BookVoucherRequestCheckAccountTransaction {
	if o == nil || IsNil(o.CheckAccountTransaction) {
		var ret BookVoucherRequestCheckAccountTransaction
		return ret
	}
...
// SetCheckAccountTransaction gets a reference to the given BookVoucherRequestCheckAccountTransaction and assigns it to the CheckAccountTransaction field.
...
func (o BookVoucherRequest) MarshalJSON() ([]byte, error) {
...
func (o BookVoucherRequest) ToMap() (map[string]interface{}, error) {
...
type NullableBookVoucherRequest struct {
	value *BookVoucherRequest
	isSet bool
}

func (v NullableBookVoucherRequest) Get() *BookVoucherRequest {
	return v.value
}

func (v *NullableBookVoucherRequest) Set(val *BookVoucherRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBookVoucherRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBookVoucherRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBookVoucherRequest(val *BookVoucherRequest) *NullableBookVoucherRequest {
	return &NullableBookVoucherRequest{value: val, isSet: true}
}

func (v NullableBookVoucherRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBookVoucherRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
