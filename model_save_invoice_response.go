...
// checks if the SaveInvoiceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SaveInvoiceResponse{}

// SaveInvoiceResponse struct for SaveInvoiceResponse
...
// SetInvoice gets a reference to the given ModelInvoiceResponse and assigns it to the Invoice field.
...
func (o *SaveInvoiceResponse) GetInvoicePos() ModelInvoicePosResponse {
	if o == nil || IsNil(o.InvoicePos) {
		var ret ModelInvoicePosResponse
		return ret
	}
	return *o.InvoicePos
}
...
// SetInvoicePos gets a reference to the given ModelInvoicePosResponse and assigns it to the InvoicePos field.
...
func (o SaveInvoiceResponse) MarshalJSON() ([]byte, error) {
...
func (o SaveInvoiceResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSaveInvoiceResponse struct {
	value *SaveInvoiceResponse
	isSet bool
}

func (v NullableSaveInvoiceResponse) Get() *SaveInvoiceResponse {
	return v.value
}

func (v *NullableSaveInvoiceResponse) Set(val *SaveInvoiceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSaveInvoiceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSaveInvoiceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaveInvoiceResponse(val *SaveInvoiceResponse) *NullableSaveInvoiceResponse {
	return &NullableSaveInvoiceResponse{value: val, isSet: true}
}

func (v NullableSaveInvoiceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaveInvoiceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
