...
// checks if the ModelCreditNotePos type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelCreditNotePos{}
...
type ModelCreditNotePos struct {
	...
	CreditNote *ModelCreditNotePosCreditNote `json:"creditNote,omitempty"`
	...
	SevClient *ModelCreditNotePosSevClient `json:"sevClient,omitempty"`
...
func (o *ModelCreditNotePos) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *ModelCreditNotePos) GetCreditNote() ModelCreditNotePosCreditNote {
	if o == nil || IsNil(o.CreditNote) {
		var ret ModelCreditNotePosCreditNote
		return ret
	}
	return *o.CreditNote
}
...
// SetCreditNote gets a reference to the given ModelCreditNotePosCreditNote and assigns it to the CreditNote field.
...
func (o *ModelCreditNotePos) SetPriceNil() {
	o.Price.Set(nil)
}
...
func (o *ModelCreditNotePos) SetPriceNetNil() {
	o.PriceNet.Set(nil)
}
...
func (o *ModelCreditNotePos) SetPriceTaxNil() {
	o.PriceTax.Set(nil)
}
...
func (o *ModelCreditNotePos) SetPriceGrossNil() {
...
func (o *ModelCreditNotePos) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ModelCreditNotePos) GetSevClient() ModelCreditNotePosSevClient {
	if o == nil || IsNil(o.SevClient) {
		var ret ModelCreditNotePosSevClient
		return ret
	}
	return *o.SevClient
}
...
// SetSevClient gets a reference to the given ModelCreditNotePosSevClient and assigns it to the SevClient field.
...
func (o *ModelCreditNotePos) SetPositionNumberNil() {
...
func (o *ModelCreditNotePos) SetTextNil() {
	o.Text.Set(nil)
}
...
func (o *ModelCreditNotePos) SetDiscountNil() {
	o.Discount.Set(nil)
}
...
func (o *ModelCreditNotePos) SetOptionalNil() {
	o.Optional.Set(nil)
}
...
func (o *ModelCreditNotePos) SetSumDiscountNil() {
...
func (o ModelCreditNotePos) MarshalJSON() ([]byte, error) {
...
func (o ModelCreditNotePos) ToMap() (map[string]interface{}, error) {
...
type NullableModelCreditNotePos struct {
	value *ModelCreditNotePos
	isSet bool
}

func (v NullableModelCreditNotePos) Get() *ModelCreditNotePos {
	return v.value
}

func (v *NullableModelCreditNotePos) Set(val *ModelCreditNotePos) {
	v.value = val
	v.isSet = true
}

func (v NullableModelCreditNotePos) IsSet() bool {
	return v.isSet
}

func (v *NullableModelCreditNotePos) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelCreditNotePos(val *ModelCreditNotePos) *NullableModelCreditNotePos {
	return &NullableModelCreditNotePos{value: val, isSet: true}
}

func (v NullableModelCreditNotePos) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelCreditNotePos) UnmarshalJSON(src []byte) error {
	v.isSet = true
