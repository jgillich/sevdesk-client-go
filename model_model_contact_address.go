...
// checks if the ModelContactAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelContactAddress{}
...
func (o *ModelContactAddress) SetStreetNil() {
	o.Street.Set(nil)
}
...
func (o *ModelContactAddress) SetZipNil() {
	o.Zip.Set(nil)
}
...
func (o *ModelContactAddress) SetCityNil() {
	o.City.Set(nil)
}
...
func (o *ModelContactAddress) SetCategoryNil() {
	o.Category.Set(nil)
}
...
func (o *ModelContactAddress) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ModelContactAddress) SetName3Nil() {
	o.Name3.Set(nil)
}
...
func (o *ModelContactAddress) SetName4Nil() {
	o.Name4.Set(nil)
}
...
func (o ModelContactAddress) MarshalJSON() ([]byte, error) {
...
func (o ModelContactAddress) ToMap() (map[string]interface{}, error) {
...
type NullableModelContactAddress struct {
	value *ModelContactAddress
	isSet bool
}

func (v NullableModelContactAddress) Get() *ModelContactAddress {
	return v.value
}

func (v *NullableModelContactAddress) Set(val *ModelContactAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableModelContactAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableModelContactAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelContactAddress(val *ModelContactAddress) *NullableModelContactAddress {
	return &NullableModelContactAddress{value: val, isSet: true}
}

func (v NullableModelContactAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelContactAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
