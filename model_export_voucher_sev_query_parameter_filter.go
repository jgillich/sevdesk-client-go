...
// checks if the ExportVoucherSevQueryParameterFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportVoucherSevQueryParameterFilter{}

// ExportVoucherSevQueryParameterFilter struct for ExportVoucherSevQueryParameterFilter
type ExportVoucherSevQueryParameterFilter struct {
	...
	Contact *ExportVoucherSevQueryParameterFilterContact `json:"contact,omitempty"`
	// filters the vouchers by amount
	StartAmount *int32 `json:"startAmount,omitempty"`
	// filters the vouchers by amount
	EndAmount *int32 `json:"endAmount,omitempty"`
}
...
func NewExportVoucherSevQueryParameterFilter() *ExportVoucherSevQueryParameterFilter {
	this := ExportVoucherSevQueryParameterFilter{}
	return &this
}
...
// GetStartPayDate returns the StartPayDate field value if set, zero value otherwise.
func (o *ExportVoucherSevQueryParameterFilter) GetStartPayDate() time.Time {
	if o == nil || IsNil(o.StartPayDate) {
		var ret time.Time
		return ret
	}
	return *o.StartPayDate
}

// GetStartPayDateOk returns a tuple with the StartPayDate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ExportVoucherSevQueryParameterFilter) GetStartPayDateOk() (*time.Time, bool) {
	if o == nil || IsNil(o.StartPayDate) {
		return nil, false
	}
	return o.StartPayDate, true
}
...
// SetStartPayDate gets a reference to the given time.Time and assigns it to the StartPayDate field.
func (o *ExportVoucherSevQueryParameterFilter) SetStartPayDate(v time.Time) {
	o.StartPayDate = &v
}

// GetEndPayDate returns the EndPayDate field value if set, zero value otherwise.
func (o *ExportVoucherSevQueryParameterFilter) GetEndPayDate() time.Time {
	if o == nil || IsNil(o.EndPayDate) {
		var ret time.Time
		return ret
	}
	return *o.EndPayDate
...
// GetEndPayDateOk returns a tuple with the EndPayDate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ExportVoucherSevQueryParameterFilter) GetEndPayDateOk() (*time.Time, bool) {
	if o == nil || IsNil(o.EndPayDate) {
		return nil, false
	}
	return o.EndPayDate, true
}
...
// SetEndPayDate gets a reference to the given time.Time and assigns it to the EndPayDate field.
...
func (o *ExportVoucherSevQueryParameterFilter) GetContact() ExportVoucherSevQueryParameterFilterContact {
	if o == nil || IsNil(o.Contact) {
		var ret ExportVoucherSevQueryParameterFilterContact
		return ret
	}
	return *o.Contact
}
...
// SetContact gets a reference to the given ExportVoucherSevQueryParameterFilterContact and assigns it to the Contact field.
...
// SetEndAmount gets a reference to the given int32 and assigns it to the EndAmount field.
func (o *ExportVoucherSevQueryParameterFilter) SetEndAmount(v int32) {
	o.EndAmount = &v
}

func (o ExportVoucherSevQueryParameterFilter) MarshalJSON() ([]byte, error) {
...
func (o ExportVoucherSevQueryParameterFilter) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.StartPayDate) {
		toSerialize["startPayDate"] = o.StartPayDate
	}
	if !IsNil(o.EndPayDate) {
		toSerialize["endPayDate"] = o.EndPayDate
	}
	if !IsNil(o.Contact) {
...
type NullableExportVoucherSevQueryParameterFilter struct {
	value *ExportVoucherSevQueryParameterFilter
	isSet bool
}

func (v NullableExportVoucherSevQueryParameterFilter) Get() *ExportVoucherSevQueryParameterFilter {
	return v.value
}

func (v *NullableExportVoucherSevQueryParameterFilter) Set(val *ExportVoucherSevQueryParameterFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableExportVoucherSevQueryParameterFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableExportVoucherSevQueryParameterFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportVoucherSevQueryParameterFilter(val *ExportVoucherSevQueryParameterFilter) *NullableExportVoucherSevQueryParameterFilter {
	return &NullableExportVoucherSevQueryParameterFilter{value: val, isSet: true}
}

func (v NullableExportVoucherSevQueryParameterFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportVoucherSevQueryParameterFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
