...
// checks if the InvoiceRender201ResponseObjectsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoiceRender201ResponseObjectsInner{}

// InvoiceRender201ResponseObjectsInner struct for InvoiceRender201ResponseObjectsInner
type InvoiceRender201ResponseObjectsInner struct {
	// ID of the (temporary) document.
	DocId *string `json:"docId,omitempty"`
	// The url location of the (temporary) document.
	PdfUrl *string `json:"pdfUrl,omitempty"`
	// The amount of pages of the document.
...
func NewInvoiceRender201ResponseObjectsInner() *InvoiceRender201ResponseObjectsInner {
	this := InvoiceRender201ResponseObjectsInner{}
	return &this
}
...
func (o InvoiceRender201ResponseObjectsInner) MarshalJSON() ([]byte, error) {
...
func (o InvoiceRender201ResponseObjectsInner) ToMap() (map[string]interface{}, error) {
...
type NullableInvoiceRender201ResponseObjectsInner struct {
	value *InvoiceRender201ResponseObjectsInner
	isSet bool
}

func (v NullableInvoiceRender201ResponseObjectsInner) Get() *InvoiceRender201ResponseObjectsInner {
	return v.value
}

func (v *NullableInvoiceRender201ResponseObjectsInner) Set(val *InvoiceRender201ResponseObjectsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceRender201ResponseObjectsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceRender201ResponseObjectsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceRender201ResponseObjectsInner(val *InvoiceRender201ResponseObjectsInner) *NullableInvoiceRender201ResponseObjectsInner {
	return &NullableInvoiceRender201ResponseObjectsInner{value: val, isSet: true}
}

func (v NullableInvoiceRender201ResponseObjectsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceRender201ResponseObjectsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
