...
// checks if the SaveInvoiceDiscountSave type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SaveInvoiceDiscountSave{}

// SaveInvoiceDiscountSave struct for SaveInvoiceDiscountSave
type SaveInvoiceDiscountSave struct {
...
func (o SaveInvoiceDiscountSave) MarshalJSON() ([]byte, error) {
...
func (o SaveInvoiceDiscountSave) ToMap() (map[string]interface{}, error) {
...
type NullableSaveInvoiceDiscountSave struct {
	value *SaveInvoiceDiscountSave
	isSet bool
}

func (v NullableSaveInvoiceDiscountSave) Get() *SaveInvoiceDiscountSave {
	return v.value
}

func (v *NullableSaveInvoiceDiscountSave) Set(val *SaveInvoiceDiscountSave) {
	v.value = val
	v.isSet = true
}

func (v NullableSaveInvoiceDiscountSave) IsSet() bool {
	return v.isSet
}

func (v *NullableSaveInvoiceDiscountSave) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaveInvoiceDiscountSave(val *SaveInvoiceDiscountSave) *NullableSaveInvoiceDiscountSave {
	return &NullableSaveInvoiceDiscountSave{value: val, isSet: true}
}

func (v NullableSaveInvoiceDiscountSave) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaveInvoiceDiscountSave) UnmarshalJSON(src []byte) error {
	v.isSet = true
