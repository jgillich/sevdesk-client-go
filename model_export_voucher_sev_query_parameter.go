...
// checks if the ExportVoucherSevQueryParameter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportVoucherSevQueryParameter{}

// ExportVoucherSevQueryParameter struct for ExportVoucherSevQueryParameter
type ExportVoucherSevQueryParameter struct {
	// Limit export
...
func NewExportVoucherSevQueryParameter(modelName interface{}, objectName interface{}) *ExportVoucherSevQueryParameter {
	this := ExportVoucherSevQueryParameter{}
...
func (o ExportVoucherSevQueryParameter) MarshalJSON() ([]byte, error) {
...
func (o ExportVoucherSevQueryParameter) ToMap() (map[string]interface{}, error) {
...
type NullableExportVoucherSevQueryParameter struct {
	value *ExportVoucherSevQueryParameter
	isSet bool
}

func (v NullableExportVoucherSevQueryParameter) Get() *ExportVoucherSevQueryParameter {
	return v.value
}

func (v *NullableExportVoucherSevQueryParameter) Set(val *ExportVoucherSevQueryParameter) {
	v.value = val
	v.isSet = true
}

func (v NullableExportVoucherSevQueryParameter) IsSet() bool {
	return v.isSet
}

func (v *NullableExportVoucherSevQueryParameter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportVoucherSevQueryParameter(val *ExportVoucherSevQueryParameter) *NullableExportVoucherSevQueryParameter {
	return &NullableExportVoucherSevQueryParameter{value: val, isSet: true}
}

func (v NullableExportVoucherSevQueryParameter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportVoucherSevQueryParameter) UnmarshalJSON(src []byte) error {
	v.isSet = true
