...
// checks if the ExportCreditNoteSevQueryParameterFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportCreditNoteSevQueryParameterFilter{}

// ExportCreditNoteSevQueryParameterFilter struct for ExportCreditNoteSevQueryParameterFilter
type ExportCreditNoteSevQueryParameterFilter struct {
	// Start date of the credit note
	StartDate *time.Time `json:"startDate,omitempty"`
	// End date of the credit note
	EndDate *time.Time `json:"endDate,omitempty"`
	Contact *ExportCreditNoteSevQueryParameterFilterContact `json:"contact,omitempty"`
...
func NewExportCreditNoteSevQueryParameterFilter() *ExportCreditNoteSevQueryParameterFilter {
	this := ExportCreditNoteSevQueryParameterFilter{}
	return &this
}
...
func (o *ExportCreditNoteSevQueryParameterFilter) GetContact() ExportCreditNoteSevQueryParameterFilterContact {
	if o == nil || IsNil(o.Contact) {
		var ret ExportCreditNoteSevQueryParameterFilterContact
		return ret
	}
	return *o.Contact
}
...
// SetContact gets a reference to the given ExportCreditNoteSevQueryParameterFilterContact and assigns it to the Contact field.
...
func (o ExportCreditNoteSevQueryParameterFilter) MarshalJSON() ([]byte, error) {
...
func (o ExportCreditNoteSevQueryParameterFilter) ToMap() (map[string]interface{}, error) {
...
type NullableExportCreditNoteSevQueryParameterFilter struct {
	value *ExportCreditNoteSevQueryParameterFilter
	isSet bool
}

func (v NullableExportCreditNoteSevQueryParameterFilter) Get() *ExportCreditNoteSevQueryParameterFilter {
	return v.value
}

func (v *NullableExportCreditNoteSevQueryParameterFilter) Set(val *ExportCreditNoteSevQueryParameterFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableExportCreditNoteSevQueryParameterFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableExportCreditNoteSevQueryParameterFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportCreditNoteSevQueryParameterFilter(val *ExportCreditNoteSevQueryParameterFilter) *NullableExportCreditNoteSevQueryParameterFilter {
	return &NullableExportCreditNoteSevQueryParameterFilter{value: val, isSet: true}
}

func (v NullableExportCreditNoteSevQueryParameterFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportCreditNoteSevQueryParameterFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
