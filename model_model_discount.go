...
// checks if the ModelDiscount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelDiscount{}
...
type ModelDiscount struct {
	...
	Object *ModelDiscountObject `json:"object,omitempty"`
...
// SetObject gets a reference to the given ModelDiscountObject and assigns it to the Object field.
...
// GetIsNet returns the IsNet field value if set, zero value otherwise.
func (o *ModelDiscount) GetIsNet() string {
	if o == nil || IsNil(o.IsNet) {
		var ret string
		return ret
	}
	return *o.IsNet
...
// GetIsNetOk returns a tuple with the IsNet field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetIsNet gets a reference to the given string and assigns it to the IsNet field.
func (o *ModelDiscount) SetIsNet(v string) {
	o.IsNet = &v
}

func (o ModelDiscount) MarshalJSON() ([]byte, error) {
...
func (o ModelDiscount) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsNet) {
		toSerialize["isNet"] = o.IsNet
	}
	return toSerialize, nil
}

type NullableModelDiscount struct {
	value *ModelDiscount
	isSet bool
}

func (v NullableModelDiscount) Get() *ModelDiscount {
	return v.value
}

func (v *NullableModelDiscount) Set(val *ModelDiscount) {
	v.value = val
	v.isSet = true
}

func (v NullableModelDiscount) IsSet() bool {
	return v.isSet
}

func (v *NullableModelDiscount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelDiscount(val *ModelDiscount) *NullableModelDiscount {
	return &NullableModelDiscount{value: val, isSet: true}
}

func (v NullableModelDiscount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelDiscount) UnmarshalJSON(src []byte) error {
	v.isSet = true
