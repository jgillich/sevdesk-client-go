...
// checks if the ModelVoucherPosResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelVoucherPosResponse{}
...
type ModelVoucherPosResponse struct {
	...
	SevClient *ModelVoucherPosResponseSevClient `json:"sevClient,omitempty"`
	Voucher ModelVoucherPosResponseVoucher `json:"voucher"`
	AccountingType ModelVoucherPosResponseAccountingType `json:"accountingType"`
	EstimatedAccountingType *ModelVoucherPosResponseEstimatedAccountingType `json:"estimatedAccountingType,omitempty"`
...
func (o *ModelVoucherPosResponse) GetSevClient() ModelVoucherPosResponseSevClient {
	if o == nil || IsNil(o.SevClient) {
		var ret ModelVoucherPosResponseSevClient
		return ret
	}
	return *o.SevClient
}
...
// SetSevClient gets a reference to the given ModelVoucherPosResponseSevClient and assigns it to the SevClient field.
...
func (o *ModelVoucherPosResponse) GetVoucher() ModelVoucherPosResponseVoucher {
	if o == nil {
		var ret ModelVoucherPosResponseVoucher
		return ret
	}
...
func (o *ModelVoucherPosResponse) GetAccountingType() ModelVoucherPosResponseAccountingType {
	if o == nil {
		var ret ModelVoucherPosResponseAccountingType
		return ret
	}
...
func (o *ModelVoucherPosResponse) GetEstimatedAccountingType() ModelVoucherPosResponseEstimatedAccountingType {
	if o == nil || IsNil(o.EstimatedAccountingType) {
		var ret ModelVoucherPosResponseEstimatedAccountingType
		return ret
	}
...
// SetEstimatedAccountingType gets a reference to the given ModelVoucherPosResponseEstimatedAccountingType and assigns it to the EstimatedAccountingType field.
...
func (o *ModelVoucherPosResponse) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o ModelVoucherPosResponse) MarshalJSON() ([]byte, error) {
...
func (o ModelVoucherPosResponse) ToMap() (map[string]interface{}, error) {
...
type NullableModelVoucherPosResponse struct {
	value *ModelVoucherPosResponse
	isSet bool
}

func (v NullableModelVoucherPosResponse) Get() *ModelVoucherPosResponse {
	return v.value
}

func (v *NullableModelVoucherPosResponse) Set(val *ModelVoucherPosResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableModelVoucherPosResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableModelVoucherPosResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelVoucherPosResponse(val *ModelVoucherPosResponse) *NullableModelVoucherPosResponse {
	return &NullableModelVoucherPosResponse{value: val, isSet: true}
}

func (v NullableModelVoucherPosResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelVoucherPosResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
