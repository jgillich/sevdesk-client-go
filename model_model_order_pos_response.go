...
// checks if the ModelOrderPosResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelOrderPosResponse{}
...
type ModelOrderPosResponse struct {
	...
	Order *ModelOrderPosResponseOrder `json:"order,omitempty"`
	...
	Unity *ModelCreditNotePosResponseUnity `json:"unity,omitempty"`
	SevClient *ModelOrderPosResponseSevClient `json:"sevClient,omitempty"`
...
func (o *ModelOrderPosResponse) GetOrder() ModelOrderPosResponseOrder {
	if o == nil || IsNil(o.Order) {
		var ret ModelOrderPosResponseOrder
		return ret
	}
	return *o.Order
}
...
// SetOrder gets a reference to the given ModelOrderPosResponseOrder and assigns it to the Order field.
...
func (o *ModelOrderPosResponse) SetPriceNil() {
	o.Price.Set(nil)
}
...
func (o *ModelOrderPosResponse) SetPriceNetNil() {
	o.PriceNet.Set(nil)
}
...
func (o *ModelOrderPosResponse) SetPriceTaxNil() {
	o.PriceTax.Set(nil)
}
...
func (o *ModelOrderPosResponse) SetPriceGrossNil() {
...
func (o *ModelOrderPosResponse) SetNameNil() {
	o.Name.Set(nil)
}
...
// SetUnity gets a reference to the given ModelCreditNotePosResponseUnity and assigns it to the Unity field.
...
func (o *ModelOrderPosResponse) GetSevClient() ModelOrderPosResponseSevClient {
	if o == nil || IsNil(o.SevClient) {
		var ret ModelOrderPosResponseSevClient
		return ret
	}
	return *o.SevClient
}
...
// SetSevClient gets a reference to the given ModelOrderPosResponseSevClient and assigns it to the SevClient field.
...
func (o *ModelOrderPosResponse) SetPositionNumberNil() {
...
func (o *ModelOrderPosResponse) SetTextNil() {
	o.Text.Set(nil)
}
...
func (o *ModelOrderPosResponse) SetDiscountNil() {
	o.Discount.Set(nil)
}
...
func (o *ModelOrderPosResponse) SetOptionalNil() {
	o.Optional.Set(nil)
}
...
func (o *ModelOrderPosResponse) SetSumDiscountNil() {
...
func (o ModelOrderPosResponse) MarshalJSON() ([]byte, error) {
...
func (o ModelOrderPosResponse) ToMap() (map[string]interface{}, error) {
...
type NullableModelOrderPosResponse struct {
	value *ModelOrderPosResponse
	isSet bool
}

func (v NullableModelOrderPosResponse) Get() *ModelOrderPosResponse {
	return v.value
}

func (v *NullableModelOrderPosResponse) Set(val *ModelOrderPosResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableModelOrderPosResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableModelOrderPosResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelOrderPosResponse(val *ModelOrderPosResponse) *NullableModelOrderPosResponse {
	return &NullableModelOrderPosResponse{value: val, isSet: true}
}

func (v NullableModelOrderPosResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelOrderPosResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
