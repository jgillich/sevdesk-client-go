...
// checks if the ModelEmail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelEmail{}
...
func (o *ModelEmail) SetObjectNil() {
	o.Object.Set(nil)
}
...
func (o *ModelEmail) SetArrivedNil() {
	o.Arrived.Set(nil)
}
...
func (o ModelEmail) MarshalJSON() ([]byte, error) {
...
func (o ModelEmail) ToMap() (map[string]interface{}, error) {
...
type NullableModelEmail struct {
	value *ModelEmail
	isSet bool
}

func (v NullableModelEmail) Get() *ModelEmail {
	return v.value
}

func (v *NullableModelEmail) Set(val *ModelEmail) {
	v.value = val
	v.isSet = true
}

func (v NullableModelEmail) IsSet() bool {
	return v.isSet
}

func (v *NullableModelEmail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelEmail(val *ModelEmail) *NullableModelEmail {
	return &NullableModelEmail{value: val, isSet: true}
}

func (v NullableModelEmail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelEmail) UnmarshalJSON(src []byte) error {
	v.isSet = true
