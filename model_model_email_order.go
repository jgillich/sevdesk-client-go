...
// checks if the ModelEmailOrder type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelEmailOrder{}
...
type ModelEmailOrder struct {
	...
	Object NullableModelEmailOrderObject `json:"object,omitempty"`
	...
	SevClient *ModelEmailOrderSevClient `json:"sevClient,omitempty"`
	// A list of mail addresses which are in the cc
	Cc NullableString `json:"cc,omitempty"`
	// A list of mail addresses which are in the bcc
	Bcc NullableString `json:"bcc,omitempty"`
	// Date the mail arrived
	Arrived NullableTime `json:"arrived,omitempty"`
}
...
// SetObject gets a reference to the given NullableModelEmailOrderObject and assigns it to the Object field.
func (o *ModelEmailOrder) SetObject(v ModelEmailOrderObject) {
	o.Object.Set(&v)
}
// SetObjectNil sets the value for Object to be an explicit nil
func (o *ModelEmailOrder) SetObjectNil() {
	o.Object.Set(nil)
}
...
func (o *ModelEmailOrder) SetTextNil() {
	o.Text.Set(nil)
}
...
func (o *ModelEmailOrder) GetSevClient() ModelEmailOrderSevClient {
	if o == nil || IsNil(o.SevClient) {
		var ret ModelEmailOrderSevClient
		return ret
	}
	return *o.SevClient
}
...
// SetSevClient gets a reference to the given ModelEmailOrderSevClient and assigns it to the SevClient field.
func (o *ModelEmailOrder) SetSevClient(v ModelEmailOrderSevClient) {
	o.SevClient = &v
}

// GetCc returns the Cc field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ModelEmailOrder) GetCc() string {
	if o == nil || IsNil(o.Cc.Get()) {
		var ret string
		return ret
	}
	return *o.Cc.Get()
...
// SetCc gets a reference to the given NullableString and assigns it to the Cc field.
func (o *ModelEmailOrder) SetCc(v string) {
	o.Cc.Set(&v)
}
// SetCcNil sets the value for Cc to be an explicit nil
func (o *ModelEmailOrder) SetCcNil() {
	o.Cc.Set(nil)
}
...
func (o *ModelEmailOrder) SetBccNil() {
	o.Bcc.Set(nil)
}
...
// GetArrived returns the Arrived field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ModelEmailOrder) GetArrived() time.Time {
	if o == nil || IsNil(o.Arrived.Get()) {
		var ret time.Time
		return ret
	}
	return *o.Arrived.Get()
}

// GetArrivedOk returns a tuple with the Arrived field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetArrived gets a reference to the given NullableTime and assigns it to the Arrived field.
func (o *ModelEmailOrder) SetArrived(v time.Time) {
	o.Arrived.Set(&v)
}
// SetArrivedNil sets the value for Arrived to be an explicit nil
func (o *ModelEmailOrder) SetArrivedNil() {
	o.Arrived.Set(nil)
}
...
func (o ModelEmailOrder) MarshalJSON() ([]byte, error) {
...
func (o ModelEmailOrder) ToMap() (map[string]interface{}, error) {
	...
	if o.Cc.IsSet() {
		toSerialize["cc"] = o.Cc.Get()
	}
	if o.Bcc.IsSet() {
		toSerialize["bcc"] = o.Bcc.Get()
	}
	if o.Arrived.IsSet() {
		toSerialize["arrived"] = o.Arrived.Get()
	}
	return toSerialize, nil
}

type NullableModelEmailOrder struct {
	value *ModelEmailOrder
	isSet bool
}

func (v NullableModelEmailOrder) Get() *ModelEmailOrder {
	return v.value
}

func (v *NullableModelEmailOrder) Set(val *ModelEmailOrder) {
	v.value = val
	v.isSet = true
}

func (v NullableModelEmailOrder) IsSet() bool {
	return v.isSet
}

func (v *NullableModelEmailOrder) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelEmailOrder(val *ModelEmailOrder) *NullableModelEmailOrder {
	return &NullableModelEmailOrder{value: val, isSet: true}
}

func (v NullableModelEmailOrder) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelEmailOrder) UnmarshalJSON(src []byte) error {
	v.isSet = true
