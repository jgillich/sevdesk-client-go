...
// checks if the ExportInvoiceSevQueryParameter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportInvoiceSevQueryParameter{}

// ExportInvoiceSevQueryParameter struct for ExportInvoiceSevQueryParameter
type ExportInvoiceSevQueryParameter struct {
	// Limit export
...
func NewExportInvoiceSevQueryParameter(modelName interface{}, objectName interface{}) *ExportInvoiceSevQueryParameter {
	this := ExportInvoiceSevQueryParameter{}
...
func (o ExportInvoiceSevQueryParameter) MarshalJSON() ([]byte, error) {
...
func (o ExportInvoiceSevQueryParameter) ToMap() (map[string]interface{}, error) {
...
type NullableExportInvoiceSevQueryParameter struct {
	value *ExportInvoiceSevQueryParameter
	isSet bool
}

func (v NullableExportInvoiceSevQueryParameter) Get() *ExportInvoiceSevQueryParameter {
	return v.value
}

func (v *NullableExportInvoiceSevQueryParameter) Set(val *ExportInvoiceSevQueryParameter) {
	v.value = val
	v.isSet = true
}

func (v NullableExportInvoiceSevQueryParameter) IsSet() bool {
	return v.isSet
}

func (v *NullableExportInvoiceSevQueryParameter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportInvoiceSevQueryParameter(val *ExportInvoiceSevQueryParameter) *NullableExportInvoiceSevQueryParameter {
	return &NullableExportInvoiceSevQueryParameter{value: val, isSet: true}
}

func (v NullableExportInvoiceSevQueryParameter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportInvoiceSevQueryParameter) UnmarshalJSON(src []byte) error {
	v.isSet = true
