...
// checks if the ModelInvoicePos type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelInvoicePos{}
...
type ModelInvoicePos struct {
	...
	Invoice *ModelInvoicePosInvoice `json:"invoice,omitempty"`
	...
	Unity ModelInvoicePosUnity `json:"unity"`
...
func (o *ModelInvoicePos) GetInvoice() ModelInvoicePosInvoice {
	if o == nil || IsNil(o.Invoice) {
		var ret ModelInvoicePosInvoice
		return ret
	}
	return *o.Invoice
}
...
// SetInvoice gets a reference to the given ModelInvoicePosInvoice and assigns it to the Invoice field.
...
func (o *ModelInvoicePos) SetPriceNil() {
	o.Price.Set(nil)
}
...
func (o *ModelInvoicePos) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ModelInvoicePos) SetPositionNumberNil() {
...
func (o *ModelInvoicePos) SetTextNil() {
	o.Text.Set(nil)
}
...
func (o *ModelInvoicePos) SetDiscountNil() {
	o.Discount.Set(nil)
}
...
func (o *ModelInvoicePos) SetSumDiscountNil() {
...
func (o *ModelInvoicePos) SetSumNetAccountingNil() {
...
func (o *ModelInvoicePos) SetSumTaxAccountingNil() {
...
func (o *ModelInvoicePos) SetSumGrossAccountingNil() {
...
func (o *ModelInvoicePos) SetPriceNetNil() {
	o.PriceNet.Set(nil)
}
...
func (o *ModelInvoicePos) SetPriceGrossNil() {
...
func (o *ModelInvoicePos) SetPriceTaxNil() {
	o.PriceTax.Set(nil)
}
...
func (o ModelInvoicePos) MarshalJSON() ([]byte, error) {
...
func (o ModelInvoicePos) ToMap() (map[string]interface{}, error) {
...
type NullableModelInvoicePos struct {
	value *ModelInvoicePos
	isSet bool
}

func (v NullableModelInvoicePos) Get() *ModelInvoicePos {
	return v.value
}

func (v *NullableModelInvoicePos) Set(val *ModelInvoicePos) {
	v.value = val
	v.isSet = true
}

func (v NullableModelInvoicePos) IsSet() bool {
	return v.isSet
}

func (v *NullableModelInvoicePos) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelInvoicePos(val *ModelInvoicePos) *NullableModelInvoicePos {
	return &NullableModelInvoicePos{value: val, isSet: true}
}

func (v NullableModelInvoicePos) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelInvoicePos) UnmarshalJSON(src []byte) error {
	v.isSet = true
