...
// checks if the ModelContact type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelContact{}
...
type ModelContact struct {
	...
	Parent NullableModelContactParent `json:"parent,omitempty"`
	...
	Category ModelContactCategory `json:"category"`
...
func (o *ModelContact) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ModelContact) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *ModelContact) SetCustomerNumberNil() {
...
// SetParent gets a reference to the given NullableModelContactParent and assigns it to the Parent field.
func (o *ModelContact) SetParent(v ModelContactParent) {
	o.Parent.Set(&v)
}
// SetParentNil sets the value for Parent to be an explicit nil
func (o *ModelContact) SetParentNil() {
	o.Parent.Set(nil)
}
...
func (o *ModelContact) SetSurenameNil() {
	o.Surename.Set(nil)
}
...
func (o *ModelContact) SetFamilynameNil() {
...
func (o *ModelContact) SetTitelNil() {
	o.Titel.Set(nil)
}
...
func (o *ModelContact) SetDescriptionNil() {
...
func (o *ModelContact) SetAcademicTitleNil() {
...
func (o *ModelContact) SetGenderNil() {
	o.Gender.Set(nil)
}
...
func (o *ModelContact) SetName2Nil() {
	o.Name2.Set(nil)
}
...
func (o *ModelContact) SetBirthdayNil() {
	o.Birthday.Set(nil)
}
...
func (o *ModelContact) SetVatNumberNil() {
	o.VatNumber.Set(nil)
}
...
func (o *ModelContact) SetBankAccountNil() {
...
func (o *ModelContact) SetBankNumberNil() {
...
func (o *ModelContact) SetDefaultCashbackTimeNil() {
...
func (o *ModelContact) SetDefaultCashbackPercentNil() {
...
func (o *ModelContact) SetDefaultTimeToPayNil() {
...
func (o *ModelContact) SetTaxNumberNil() {
	o.TaxNumber.Set(nil)
}
...
func (o *ModelContact) SetTaxOfficeNil() {
	o.TaxOffice.Set(nil)
}
...
func (o *ModelContact) SetExemptVatNil() {
	o.ExemptVat.Set(nil)
}
...
func (o *ModelContact) SetTaxTypeNil() {
	o.TaxType.Set(nil)
}
...
func (o *ModelContact) SetTaxSetNil() {
	o.TaxSet.Set(nil)
}
...
func (o *ModelContact) SetDefaultDiscountAmountNil() {
...
func (o *ModelContact) SetDefaultDiscountPercentageNil() {
...
func (o *ModelContact) SetBuyerReferenceNil() {
...
func (o *ModelContact) SetGovernmentAgencyNil() {
...
func (o ModelContact) MarshalJSON() ([]byte, error) {
...
func (o ModelContact) ToMap() (map[string]interface{}, error) {
...
type NullableModelContact struct {
	value *ModelContact
	isSet bool
}

func (v NullableModelContact) Get() *ModelContact {
	return v.value
}

func (v *NullableModelContact) Set(val *ModelContact) {
	v.value = val
	v.isSet = true
}

func (v NullableModelContact) IsSet() bool {
	return v.isSet
}

func (v *NullableModelContact) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelContact(val *ModelContact) *NullableModelContact {
	return &NullableModelContact{value: val, isSet: true}
}

func (v NullableModelContact) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelContact) UnmarshalJSON(src []byte) error {
	v.isSet = true
