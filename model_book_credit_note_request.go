...
// checks if the BookCreditNoteRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BookCreditNoteRequest{}

// BookCreditNoteRequest struct for BookCreditNoteRequest
type BookCreditNoteRequest struct {
	...
	CheckAccount BookVoucherRequestCheckAccount `json:"checkAccount"`
	CheckAccountTransaction *BookCreditNoteRequestCheckAccountTransaction `json:"checkAccountTransaction,omitempty"`
...
func (o *BookCreditNoteRequest) GetCheckAccount() BookVoucherRequestCheckAccount {
	if o == nil {
		var ret BookVoucherRequestCheckAccount
		return ret
	}
...
// GetCheckAccountTransaction returns the CheckAccountTransaction field value if set, zero value otherwise.
func (o *BookCreditNoteRequest) GetCheckAccountTransaction() BookCreditNoteRequestCheckAccountTransaction {
	if o == nil || IsNil(o.CheckAccountTransaction) {
		var ret BookCreditNoteRequestCheckAccountTransaction
		return ret
	}
	return *o.CheckAccountTransaction
}

// GetCheckAccountTransactionOk returns a tuple with the CheckAccountTransaction field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BookCreditNoteRequest) GetCheckAccountTransactionOk() (*BookCreditNoteRequestCheckAccountTransaction, bool) {
	if o == nil || IsNil(o.CheckAccountTransaction) {
		return nil, false
	}
	return o.CheckAccountTransaction, true
}
...
// SetCheckAccountTransaction gets a reference to the given BookCreditNoteRequestCheckAccountTransaction and assigns it to the CheckAccountTransaction field.
func (o *BookCreditNoteRequest) SetCheckAccountTransaction(v BookCreditNoteRequestCheckAccountTransaction) {
	o.CheckAccountTransaction = &v
}

// GetCreateFeed returns the CreateFeed field value if set, zero value otherwise.
func (o *BookCreditNoteRequest) GetCreateFeed() bool {
	if o == nil || IsNil(o.CreateFeed) {
		var ret bool
		return ret
	}
	return *o.CreateFeed
...
// GetCreateFeedOk returns a tuple with the CreateFeed field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BookCreditNoteRequest) GetCreateFeedOk() (*bool, bool) {
	if o == nil || IsNil(o.CreateFeed) {
		return nil, false
	}
	return o.CreateFeed, true
}
...
// SetCreateFeed gets a reference to the given bool and assigns it to the CreateFeed field.
func (o *BookCreditNoteRequest) SetCreateFeed(v bool) {
	o.CreateFeed = &v
}

func (o BookCreditNoteRequest) MarshalJSON() ([]byte, error) {
...
func (o BookCreditNoteRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["amount"] = o.Amount
	toSerialize["date"] = o.Date
	toSerialize["type"] = o.Type
	toSerialize["checkAccount"] = o.CheckAccount
	if !IsNil(o.CheckAccountTransaction) {
		toSerialize["checkAccountTransaction"] = o.CheckAccountTransaction
	}
	if !IsNil(o.CreateFeed) {
		toSerialize["createFeed"] = o.CreateFeed
	}
	return toSerialize, nil
}

type NullableBookCreditNoteRequest struct {
	value *BookCreditNoteRequest
	isSet bool
}

func (v NullableBookCreditNoteRequest) Get() *BookCreditNoteRequest {
	return v.value
}

func (v *NullableBookCreditNoteRequest) Set(val *BookCreditNoteRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBookCreditNoteRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBookCreditNoteRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBookCreditNoteRequest(val *BookCreditNoteRequest) *NullableBookCreditNoteRequest {
	return &NullableBookCreditNoteRequest{value: val, isSet: true}
}

func (v NullableBookCreditNoteRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBookCreditNoteRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
