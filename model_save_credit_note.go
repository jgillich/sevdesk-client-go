...
// checks if the SaveCreditNote type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SaveCreditNote{}

// SaveCreditNote struct for SaveCreditNote
type SaveCreditNote struct {
	...
	CreditNotePosDelete *SaveCreditNoteCreditNotePosDelete `json:"creditNotePosDelete,omitempty"`
	// Filename of a previously upload file which should be attached.
	Filename **os.File `json:"filename,omitempty"`
	DiscountSave *SaveCreditNoteDiscountSave `json:"discountSave,omitempty"`
	DiscountDelete *SaveCreditNoteDiscountDelete `json:"discountDelete,omitempty"`
}
...
// GetCreditNotePosSave returns the CreditNotePosSave field value if set, zero value otherwise.
func (o *SaveCreditNote) GetCreditNotePosSave() ModelCreditNotePos {
	if o == nil || IsNil(o.CreditNotePosSave) {
		var ret ModelCreditNotePos
		return ret
	}
	return *o.CreditNotePosSave
}

// GetCreditNotePosSaveOk returns a tuple with the CreditNotePosSave field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SaveCreditNote) GetCreditNotePosSaveOk() (*ModelCreditNotePos, bool) {
	if o == nil || IsNil(o.CreditNotePosSave) {
		return nil, false
	}
	return o.CreditNotePosSave, true
}
...
// SetCreditNotePosSave gets a reference to the given ModelCreditNotePos and assigns it to the CreditNotePosSave field.
func (o *SaveCreditNote) SetCreditNotePosSave(v ModelCreditNotePos) {
	o.CreditNotePosSave = &v
}

// GetCreditNotePosDelete returns the CreditNotePosDelete field value if set, zero value otherwise.
func (o *SaveCreditNote) GetCreditNotePosDelete() SaveCreditNoteCreditNotePosDelete {
	if o == nil || IsNil(o.CreditNotePosDelete) {
		var ret SaveCreditNoteCreditNotePosDelete
		return ret
	}
	return *o.CreditNotePosDelete
}

// GetCreditNotePosDeleteOk returns a tuple with the CreditNotePosDelete field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SaveCreditNote) GetCreditNotePosDeleteOk() (*SaveCreditNoteCreditNotePosDelete, bool) {
	if o == nil || IsNil(o.CreditNotePosDelete) {
		return nil, false
	}
	return o.CreditNotePosDelete, true
}
...
// SetCreditNotePosDelete gets a reference to the given SaveCreditNoteCreditNotePosDelete and assigns it to the CreditNotePosDelete field.
func (o *SaveCreditNote) SetCreditNotePosDelete(v SaveCreditNoteCreditNotePosDelete) {
	o.CreditNotePosDelete = &v
}
...
func (o *SaveCreditNote) GetDiscountSave() SaveCreditNoteDiscountSave {
	if o == nil || IsNil(o.DiscountSave) {
		var ret SaveCreditNoteDiscountSave
		return ret
	}
...
// SetDiscountSave gets a reference to the given SaveCreditNoteDiscountSave and assigns it to the DiscountSave field.
...
func (o *SaveCreditNote) GetDiscountDelete() SaveCreditNoteDiscountDelete {
	if o == nil || IsNil(o.DiscountDelete) {
		var ret SaveCreditNoteDiscountDelete
		return ret
	}
...
// SetDiscountDelete gets a reference to the given SaveCreditNoteDiscountDelete and assigns it to the DiscountDelete field.
func (o *SaveCreditNote) SetDiscountDelete(v SaveCreditNoteDiscountDelete) {
	o.DiscountDelete = &v
}

func (o SaveCreditNote) MarshalJSON() ([]byte, error) {
...
func (o SaveCreditNote) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["creditNote"] = o.CreditNote
	if !IsNil(o.CreditNotePosSave) {
		toSerialize["creditNotePosSave"] = o.CreditNotePosSave
	}
	if !IsNil(o.CreditNotePosDelete) {
		toSerialize["creditNotePosDelete"] = o.CreditNotePosDelete
	}
	if !IsNil(o.Filename) {
...
type NullableSaveCreditNote struct {
	value *SaveCreditNote
	isSet bool
}

func (v NullableSaveCreditNote) Get() *SaveCreditNote {
	return v.value
}

func (v *NullableSaveCreditNote) Set(val *SaveCreditNote) {
	v.value = val
	v.isSet = true
}

func (v NullableSaveCreditNote) IsSet() bool {
	return v.isSet
}

func (v *NullableSaveCreditNote) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaveCreditNote(val *SaveCreditNote) *NullableSaveCreditNote {
	return &NullableSaveCreditNote{value: val, isSet: true}
}

func (v NullableSaveCreditNote) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaveCreditNote) UnmarshalJSON(src []byte) error {
	v.isSet = true
