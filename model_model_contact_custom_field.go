...
// checks if the ModelContactCustomField type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelContactCustomField{}

// ModelContactCustomField contact fields model
type ModelContactCustomField struct {
	Contact ModelContactCustomFieldContact `json:"contact"`
	ContactCustomFieldSetting ModelContactCustomFieldContactCustomFieldSetting `json:"contactCustomFieldSetting"`
...
func NewModelContactCustomField(contact ModelContactCustomFieldContact, contactCustomFieldSetting ModelContactCustomFieldContactCustomFieldSetting, value string, objectName string) *ModelContactCustomField {
	this := ModelContactCustomField{}
	this.Contact = contact
	this.ContactCustomFieldSetting = contactCustomFieldSetting
	this.Value = value
...
// GetContactCustomFieldSetting returns the ContactCustomFieldSetting field value
...
// GetContactCustomFieldSettingOk returns a tuple with the ContactCustomFieldSetting field value
// and a boolean to check if the value has been set.
...
// SetContactCustomFieldSetting sets field value
...
func (o ModelContactCustomField) MarshalJSON() ([]byte, error) {
...
func (o ModelContactCustomField) ToMap() (map[string]interface{}, error) {
...
type NullableModelContactCustomField struct {
	value *ModelContactCustomField
	isSet bool
}

func (v NullableModelContactCustomField) Get() *ModelContactCustomField {
	return v.value
}

func (v *NullableModelContactCustomField) Set(val *ModelContactCustomField) {
	v.value = val
	v.isSet = true
}

func (v NullableModelContactCustomField) IsSet() bool {
	return v.isSet
}

func (v *NullableModelContactCustomField) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelContactCustomField(val *ModelContactCustomField) *NullableModelContactCustomField {
	return &NullableModelContactCustomField{value: val, isSet: true}
}

func (v NullableModelContactCustomField) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelContactCustomField) UnmarshalJSON(src []byte) error {
	v.isSet = true
