...
// checks if the ExportTransactionsSevQueryParameterFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportTransactionsSevQueryParameterFilter{}

// ExportTransactionsSevQueryParameterFilter struct for ExportTransactionsSevQueryParameterFilter
type ExportTransactionsSevQueryParameterFilter struct {
	// the payment purpose
	...
	CheckAccount *ExportTransactionsSevQueryParameterFilterCheckAccount `json:"checkAccount,omitempty"`
}
...
func NewExportTransactionsSevQueryParameterFilter() *ExportTransactionsSevQueryParameterFilter {
	this := ExportTransactionsSevQueryParameterFilter{}
	return &this
}
...
func (o *ExportTransactionsSevQueryParameterFilter) GetCheckAccount() ExportTransactionsSevQueryParameterFilterCheckAccount {
	if o == nil || IsNil(o.CheckAccount) {
		var ret ExportTransactionsSevQueryParameterFilterCheckAccount
		return ret
	}
...
// SetCheckAccount gets a reference to the given ExportTransactionsSevQueryParameterFilterCheckAccount and assigns it to the CheckAccount field.
func (o *ExportTransactionsSevQueryParameterFilter) SetCheckAccount(v ExportTransactionsSevQueryParameterFilterCheckAccount) {
	o.CheckAccount = &v
}

func (o ExportTransactionsSevQueryParameterFilter) MarshalJSON() ([]byte, error) {
...
func (o ExportTransactionsSevQueryParameterFilter) ToMap() (map[string]interface{}, error) {
...
type NullableExportTransactionsSevQueryParameterFilter struct {
	value *ExportTransactionsSevQueryParameterFilter
	isSet bool
}

func (v NullableExportTransactionsSevQueryParameterFilter) Get() *ExportTransactionsSevQueryParameterFilter {
	return v.value
}

func (v *NullableExportTransactionsSevQueryParameterFilter) Set(val *ExportTransactionsSevQueryParameterFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableExportTransactionsSevQueryParameterFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableExportTransactionsSevQueryParameterFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportTransactionsSevQueryParameterFilter(val *ExportTransactionsSevQueryParameterFilter) *NullableExportTransactionsSevQueryParameterFilter {
	return &NullableExportTransactionsSevQueryParameterFilter{value: val, isSet: true}
}

func (v NullableExportTransactionsSevQueryParameterFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportTransactionsSevQueryParameterFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
