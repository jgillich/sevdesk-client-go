...
// checks if the ExportCreditNoteSevQueryParameter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportCreditNoteSevQueryParameter{}

// ExportCreditNoteSevQueryParameter struct for ExportCreditNoteSevQueryParameter
type ExportCreditNoteSevQueryParameter struct {
	// Limit export
	...
	Filter *ExportCreditNoteSevQueryParameterFilter `json:"filter,omitempty"`
}
...
func NewExportCreditNoteSevQueryParameter(modelName interface{}, objectName interface{}) *ExportCreditNoteSevQueryParameter {
	this := ExportCreditNoteSevQueryParameter{}
...
func (o *ExportCreditNoteSevQueryParameter) GetFilter() ExportCreditNoteSevQueryParameterFilter {
	if o == nil || IsNil(o.Filter) {
		var ret ExportCreditNoteSevQueryParameterFilter
		return ret
	}
	return *o.Filter
}
...
// SetFilter gets a reference to the given ExportCreditNoteSevQueryParameterFilter and assigns it to the Filter field.
func (o *ExportCreditNoteSevQueryParameter) SetFilter(v ExportCreditNoteSevQueryParameterFilter) {
	o.Filter = &v
}

func (o ExportCreditNoteSevQueryParameter) MarshalJSON() ([]byte, error) {
...
func (o ExportCreditNoteSevQueryParameter) ToMap() (map[string]interface{}, error) {
...
type NullableExportCreditNoteSevQueryParameter struct {
	value *ExportCreditNoteSevQueryParameter
	isSet bool
}

func (v NullableExportCreditNoteSevQueryParameter) Get() *ExportCreditNoteSevQueryParameter {
	return v.value
}

func (v *NullableExportCreditNoteSevQueryParameter) Set(val *ExportCreditNoteSevQueryParameter) {
	v.value = val
	v.isSet = true
}

func (v NullableExportCreditNoteSevQueryParameter) IsSet() bool {
	return v.isSet
}

func (v *NullableExportCreditNoteSevQueryParameter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportCreditNoteSevQueryParameter(val *ExportCreditNoteSevQueryParameter) *NullableExportCreditNoteSevQueryParameter {
	return &NullableExportCreditNoteSevQueryParameter{value: val, isSet: true}
}

func (v NullableExportCreditNoteSevQueryParameter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportCreditNoteSevQueryParameter) UnmarshalJSON(src []byte) error {
	v.isSet = true
