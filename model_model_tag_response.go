...
// checks if the ModelTagResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelTagResponse{}
...
func (o ModelTagResponse) MarshalJSON() ([]byte, error) {
...
func (o ModelTagResponse) ToMap() (map[string]interface{}, error) {
...
type NullableModelTagResponse struct {
	value *ModelTagResponse
	isSet bool
}

func (v NullableModelTagResponse) Get() *ModelTagResponse {
	return v.value
}

func (v *NullableModelTagResponse) Set(val *ModelTagResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableModelTagResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableModelTagResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelTagResponse(val *ModelTagResponse) *NullableModelTagResponse {
	return &NullableModelTagResponse{value: val, isSet: true}
}

func (v NullableModelTagResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelTagResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
