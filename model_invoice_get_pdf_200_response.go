...
// checks if the InvoiceGetPdf200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoiceGetPdf200Response{}

// InvoiceGetPdf200Response struct for InvoiceGetPdf200Response
type InvoiceGetPdf200Response struct {
...
func (o *InvoiceGetPdf200Response) GetBase64encoded() string {
	if o == nil || IsNil(o.Base64encoded) {
		var ret string
		return ret
	}
...
func (o InvoiceGetPdf200Response) MarshalJSON() ([]byte, error) {
...
func (o InvoiceGetPdf200Response) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Base64encoded) {
		toSerialize["base64encoded"] = o.Base64encoded
	}
	return toSerialize, nil
}

type NullableInvoiceGetPdf200Response struct {
	value *InvoiceGetPdf200Response
	isSet bool
}

func (v NullableInvoiceGetPdf200Response) Get() *InvoiceGetPdf200Response {
	return v.value
}

func (v *NullableInvoiceGetPdf200Response) Set(val *InvoiceGetPdf200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceGetPdf200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceGetPdf200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceGetPdf200Response(val *InvoiceGetPdf200Response) *NullableInvoiceGetPdf200Response {
	return &NullableInvoiceGetPdf200Response{value: val, isSet: true}
}

func (v NullableInvoiceGetPdf200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceGetPdf200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
