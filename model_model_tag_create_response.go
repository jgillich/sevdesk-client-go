...
// checks if the ModelTagCreateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelTagCreateResponse{}
...
type ModelTagCreateResponse struct {
	...
	Tag *ModelTagCreateResponseTag `json:"tag,omitempty"`
	Object *ModelTagCreateResponseObject `json:"object,omitempty"`
	SevClient *ModelTagCreateResponseSevClient `json:"sevClient,omitempty"`
}
...
func (o *ModelTagCreateResponse) GetTag() ModelTagCreateResponseTag {
	if o == nil || IsNil(o.Tag) {
		var ret ModelTagCreateResponseTag
		return ret
	}
	return *o.Tag
}
...
// SetTag gets a reference to the given ModelTagCreateResponseTag and assigns it to the Tag field.
...
func (o *ModelTagCreateResponse) GetObject() ModelTagCreateResponseObject {
	if o == nil || IsNil(o.Object) {
		var ret ModelTagCreateResponseObject
		return ret
	}
	return *o.Object
}
...
// SetObject gets a reference to the given ModelTagCreateResponseObject and assigns it to the Object field.
...
func (o *ModelTagCreateResponse) GetSevClient() ModelTagCreateResponseSevClient {
	if o == nil || IsNil(o.SevClient) {
		var ret ModelTagCreateResponseSevClient
		return ret
	}
	return *o.SevClient
}
...
// SetSevClient gets a reference to the given ModelTagCreateResponseSevClient and assigns it to the SevClient field.
func (o *ModelTagCreateResponse) SetSevClient(v ModelTagCreateResponseSevClient) {
	o.SevClient = &v
}

func (o ModelTagCreateResponse) MarshalJSON() ([]byte, error) {
...
func (o ModelTagCreateResponse) ToMap() (map[string]interface{}, error) {
...
type NullableModelTagCreateResponse struct {
	value *ModelTagCreateResponse
	isSet bool
}

func (v NullableModelTagCreateResponse) Get() *ModelTagCreateResponse {
	return v.value
}

func (v *NullableModelTagCreateResponse) Set(val *ModelTagCreateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableModelTagCreateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableModelTagCreateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelTagCreateResponse(val *ModelTagCreateResponse) *NullableModelTagCreateResponse {
	return &NullableModelTagCreateResponse{value: val, isSet: true}
}

func (v NullableModelTagCreateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelTagCreateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
