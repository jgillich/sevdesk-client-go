...
// checks if the GetContactTabsItemCountById200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetContactTabsItemCountById200Response{}

// GetContactTabsItemCountById200Response struct for GetContactTabsItemCountById200Response
type GetContactTabsItemCountById200Response struct {
...
func NewGetContactTabsItemCountById200Response() *GetContactTabsItemCountById200Response {
	this := GetContactTabsItemCountById200Response{}
	return &this
}
...
// SetOrders gets a reference to the given float32 and assigns it to the Orders field.
func (o *GetContactTabsItemCountById200Response) SetOrders(v float32) {
	o.Orders = &v
}
...
// SetCreditNotes gets a reference to the given float32 and assigns it to the CreditNotes field.
...
// SetDocuments gets a reference to the given float32 and assigns it to the Documents field.
...
// SetVouchers gets a reference to the given float32 and assigns it to the Vouchers field.
...
// SetLetters gets a reference to the given float32 and assigns it to the Letters field.
...
// GetInvoicePos returns the InvoicePos field value if set, zero value otherwise.
func (o *GetContactTabsItemCountById200Response) GetInvoicePos() float32 {
	if o == nil || IsNil(o.InvoicePos) {
		var ret float32
		return ret
	}
	return *o.InvoicePos
...
// GetInvoicePosOk returns a tuple with the InvoicePos field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GetContactTabsItemCountById200Response) GetInvoicePosOk() (*float32, bool) {
	if o == nil || IsNil(o.InvoicePos) {
		return nil, false
	}
	return o.InvoicePos, true
}
...
// SetInvoicePos gets a reference to the given float32 and assigns it to the InvoicePos field.
func (o *GetContactTabsItemCountById200Response) SetInvoicePos(v float32) {
	o.InvoicePos = &v
}

func (o GetContactTabsItemCountById200Response) MarshalJSON() ([]byte, error) {
...
func (o GetContactTabsItemCountById200Response) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InvoicePos) {
		toSerialize["invoicePos"] = o.InvoicePos
	}
	return toSerialize, nil
}

type NullableGetContactTabsItemCountById200Response struct {
	value *GetContactTabsItemCountById200Response
	isSet bool
}

func (v NullableGetContactTabsItemCountById200Response) Get() *GetContactTabsItemCountById200Response {
	return v.value
}

func (v *NullableGetContactTabsItemCountById200Response) Set(val *GetContactTabsItemCountById200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetContactTabsItemCountById200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetContactTabsItemCountById200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetContactTabsItemCountById200Response(val *GetContactTabsItemCountById200Response) *NullableGetContactTabsItemCountById200Response {
	return &NullableGetContactTabsItemCountById200Response{value: val, isSet: true}
}

func (v NullableGetContactTabsItemCountById200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetContactTabsItemCountById200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
