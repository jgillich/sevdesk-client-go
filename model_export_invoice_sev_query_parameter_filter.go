...
// checks if the ExportInvoiceSevQueryParameterFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportInvoiceSevQueryParameterFilter{}

// ExportInvoiceSevQueryParameterFilter struct for ExportInvoiceSevQueryParameterFilter
type ExportInvoiceSevQueryParameterFilter struct {
	...
	Contact *ExportInvoiceSevQueryParameterFilterContact `json:"contact,omitempty"`
...
func NewExportInvoiceSevQueryParameterFilter() *ExportInvoiceSevQueryParameterFilter {
	this := ExportInvoiceSevQueryParameterFilter{}
	return &this
}
...
func (o *ExportInvoiceSevQueryParameterFilter) GetContact() ExportInvoiceSevQueryParameterFilterContact {
	if o == nil || IsNil(o.Contact) {
		var ret ExportInvoiceSevQueryParameterFilterContact
		return ret
	}
	return *o.Contact
}
...
// SetContact gets a reference to the given ExportInvoiceSevQueryParameterFilterContact and assigns it to the Contact field.
...
func (o ExportInvoiceSevQueryParameterFilter) MarshalJSON() ([]byte, error) {
...
func (o ExportInvoiceSevQueryParameterFilter) ToMap() (map[string]interface{}, error) {
...
type NullableExportInvoiceSevQueryParameterFilter struct {
	value *ExportInvoiceSevQueryParameterFilter
	isSet bool
}

func (v NullableExportInvoiceSevQueryParameterFilter) Get() *ExportInvoiceSevQueryParameterFilter {
	return v.value
}

func (v *NullableExportInvoiceSevQueryParameterFilter) Set(val *ExportInvoiceSevQueryParameterFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableExportInvoiceSevQueryParameterFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableExportInvoiceSevQueryParameterFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportInvoiceSevQueryParameterFilter(val *ExportInvoiceSevQueryParameterFilter) *NullableExportInvoiceSevQueryParameterFilter {
	return &NullableExportInvoiceSevQueryParameterFilter{value: val, isSet: true}
}

func (v NullableExportInvoiceSevQueryParameterFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportInvoiceSevQueryParameterFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
