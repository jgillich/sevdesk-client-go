...
// checks if the SaveCreditNoteDiscountSave type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SaveCreditNoteDiscountSave{}

// SaveCreditNoteDiscountSave struct for SaveCreditNoteDiscountSave
type SaveCreditNoteDiscountSave struct {
...
func NewSaveCreditNoteDiscountSave(discount bool, text string, percentage bool, value float32, objectName string, mapAll bool) *SaveCreditNoteDiscountSave {
	this := SaveCreditNoteDiscountSave{}
...
func (o SaveCreditNoteDiscountSave) MarshalJSON() ([]byte, error) {
...
func (o SaveCreditNoteDiscountSave) ToMap() (map[string]interface{}, error) {
...
type NullableSaveCreditNoteDiscountSave struct {
	value *SaveCreditNoteDiscountSave
	isSet bool
}

func (v NullableSaveCreditNoteDiscountSave) Get() *SaveCreditNoteDiscountSave {
	return v.value
}

func (v *NullableSaveCreditNoteDiscountSave) Set(val *SaveCreditNoteDiscountSave) {
	v.value = val
	v.isSet = true
}

func (v NullableSaveCreditNoteDiscountSave) IsSet() bool {
	return v.isSet
}

func (v *NullableSaveCreditNoteDiscountSave) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaveCreditNoteDiscountSave(val *SaveCreditNoteDiscountSave) *NullableSaveCreditNoteDiscountSave {
	return &NullableSaveCreditNoteDiscountSave{value: val, isSet: true}
}

func (v NullableSaveCreditNoteDiscountSave) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaveCreditNoteDiscountSave) UnmarshalJSON(src []byte) error {
	v.isSet = true
