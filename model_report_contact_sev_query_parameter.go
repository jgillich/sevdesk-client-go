...
// checks if the ReportContactSevQueryParameter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportContactSevQueryParameter{}

// ReportContactSevQueryParameter struct for ReportContactSevQueryParameter
type ReportContactSevQueryParameter struct {
	// Limit export
...
func NewReportContactSevQueryParameter(modelName interface{}, objectName interface{}) *ReportContactSevQueryParameter {
	this := ReportContactSevQueryParameter{}
...
func (o ReportContactSevQueryParameter) MarshalJSON() ([]byte, error) {
...
func (o ReportContactSevQueryParameter) ToMap() (map[string]interface{}, error) {
...
type NullableReportContactSevQueryParameter struct {
	value *ReportContactSevQueryParameter
	isSet bool
}

func (v NullableReportContactSevQueryParameter) Get() *ReportContactSevQueryParameter {
	return v.value
}

func (v *NullableReportContactSevQueryParameter) Set(val *ReportContactSevQueryParameter) {
	v.value = val
	v.isSet = true
}

func (v NullableReportContactSevQueryParameter) IsSet() bool {
	return v.isSet
}

func (v *NullableReportContactSevQueryParameter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportContactSevQueryParameter(val *ReportContactSevQueryParameter) *NullableReportContactSevQueryParameter {
	return &NullableReportContactSevQueryParameter{value: val, isSet: true}
}

func (v NullableReportContactSevQueryParameter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportContactSevQueryParameter) UnmarshalJSON(src []byte) error {
	v.isSet = true
