...
// checks if the ReportOrderSevQueryParameter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportOrderSevQueryParameter{}

// ReportOrderSevQueryParameter struct for ReportOrderSevQueryParameter
type ReportOrderSevQueryParameter struct {
	// Limit export
	...
	Filter *ReportOrderSevQueryParameterFilter `json:"filter,omitempty"`
}
...
func NewReportOrderSevQueryParameter(modelName interface{}, objectName interface{}) *ReportOrderSevQueryParameter {
	this := ReportOrderSevQueryParameter{}
...
func (o *ReportOrderSevQueryParameter) GetFilter() ReportOrderSevQueryParameterFilter {
	if o == nil || IsNil(o.Filter) {
		var ret ReportOrderSevQueryParameterFilter
		return ret
	}
	return *o.Filter
}
...
// SetFilter gets a reference to the given ReportOrderSevQueryParameterFilter and assigns it to the Filter field.
func (o *ReportOrderSevQueryParameter) SetFilter(v ReportOrderSevQueryParameterFilter) {
	o.Filter = &v
}

func (o ReportOrderSevQueryParameter) MarshalJSON() ([]byte, error) {
...
func (o ReportOrderSevQueryParameter) ToMap() (map[string]interface{}, error) {
...
type NullableReportOrderSevQueryParameter struct {
	value *ReportOrderSevQueryParameter
	isSet bool
}

func (v NullableReportOrderSevQueryParameter) Get() *ReportOrderSevQueryParameter {
	return v.value
}

func (v *NullableReportOrderSevQueryParameter) Set(val *ReportOrderSevQueryParameter) {
	v.value = val
	v.isSet = true
}

func (v NullableReportOrderSevQueryParameter) IsSet() bool {
	return v.isSet
}

func (v *NullableReportOrderSevQueryParameter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportOrderSevQueryParameter(val *ReportOrderSevQueryParameter) *NullableReportOrderSevQueryParameter {
	return &NullableReportOrderSevQueryParameter{value: val, isSet: true}
}

func (v NullableReportOrderSevQueryParameter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportOrderSevQueryParameter) UnmarshalJSON(src []byte) error {
	v.isSet = true
