...
// checks if the ModelContactAddressUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelContactAddressUpdate{}

// ModelContactAddressUpdate ContactAddress model
type ModelContactAddressUpdate struct {
	Contact NullableModelContactAddressUpdateContact `json:"contact,omitempty"`
	// Street name
	...
	Country NullableModelContactAddressUpdateCountry `json:"country,omitempty"`
...
func NewModelContactAddressUpdate() *ModelContactAddressUpdate {
	this := ModelContactAddressUpdate{}
	return &this
}
...
func (o *ModelContactAddressUpdate) GetContact() ModelContactAddressUpdateContact {
	if o == nil || IsNil(o.Contact.Get()) {
		var ret ModelContactAddressUpdateContact
		return ret
	}
...
// SetContact gets a reference to the given NullableModelContactAddressUpdateContact and assigns it to the Contact field.
func (o *ModelContactAddressUpdate) SetContact(v ModelContactAddressUpdateContact) {
	o.Contact.Set(&v)
}
// SetContactNil sets the value for Contact to be an explicit nil
func (o *ModelContactAddressUpdate) SetContactNil() {
	o.Contact.Set(nil)
}
...
func (o *ModelContactAddressUpdate) SetStreetNil() {
	o.Street.Set(nil)
}
...
func (o *ModelContactAddressUpdate) SetZipNil() {
	o.Zip.Set(nil)
}
...
func (o *ModelContactAddressUpdate) SetCityNil() {
	o.City.Set(nil)
}
...
func (o *ModelContactAddressUpdate) GetCountry() ModelContactAddressUpdateCountry {
	if o == nil || IsNil(o.Country.Get()) {
		var ret ModelContactAddressUpdateCountry
		return ret
	}
...
// SetCountry gets a reference to the given NullableModelContactAddressUpdateCountry and assigns it to the Country field.
func (o *ModelContactAddressUpdate) SetCountry(v ModelContactAddressUpdateCountry) {
	o.Country.Set(&v)
}
// SetCountryNil sets the value for Country to be an explicit nil
func (o *ModelContactAddressUpdate) SetCountryNil() {
	o.Country.Set(nil)
}
...
func (o *ModelContactAddressUpdate) SetCategoryNil() {
	o.Category.Set(nil)
}
...
func (o *ModelContactAddressUpdate) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ModelContactAddressUpdate) SetName3Nil() {
	o.Name3.Set(nil)
}
...
func (o *ModelContactAddressUpdate) SetName4Nil() {
	o.Name4.Set(nil)
}
...
func (o ModelContactAddressUpdate) MarshalJSON() ([]byte, error) {
...
func (o ModelContactAddressUpdate) ToMap() (map[string]interface{}, error) {
...
type NullableModelContactAddressUpdate struct {
	value *ModelContactAddressUpdate
	isSet bool
}

func (v NullableModelContactAddressUpdate) Get() *ModelContactAddressUpdate {
	return v.value
}

func (v *NullableModelContactAddressUpdate) Set(val *ModelContactAddressUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableModelContactAddressUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableModelContactAddressUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelContactAddressUpdate(val *ModelContactAddressUpdate) *NullableModelContactAddressUpdate {
	return &NullableModelContactAddressUpdate{value: val, isSet: true}
}

func (v NullableModelContactAddressUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelContactAddressUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
