...
// checks if the ReportVoucherSevQueryParameter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportVoucherSevQueryParameter{}

// ReportVoucherSevQueryParameter struct for ReportVoucherSevQueryParameter
type ReportVoucherSevQueryParameter struct {
	// Limit export
	...
	Filter *ExportVoucherSevQueryParameterFilter `json:"filter,omitempty"`
}
...
func NewReportVoucherSevQueryParameter(modelName interface{}, objectName interface{}) *ReportVoucherSevQueryParameter {
	this := ReportVoucherSevQueryParameter{}
...
func (o *ReportVoucherSevQueryParameter) GetFilter() ExportVoucherSevQueryParameterFilter {
	if o == nil || IsNil(o.Filter) {
		var ret ExportVoucherSevQueryParameterFilter
		return ret
	}
	return *o.Filter
}
...
// SetFilter gets a reference to the given ExportVoucherSevQueryParameterFilter and assigns it to the Filter field.
func (o *ReportVoucherSevQueryParameter) SetFilter(v ExportVoucherSevQueryParameterFilter) {
	o.Filter = &v
}

func (o ReportVoucherSevQueryParameter) MarshalJSON() ([]byte, error) {
...
func (o ReportVoucherSevQueryParameter) ToMap() (map[string]interface{}, error) {
...
type NullableReportVoucherSevQueryParameter struct {
	value *ReportVoucherSevQueryParameter
	isSet bool
}

func (v NullableReportVoucherSevQueryParameter) Get() *ReportVoucherSevQueryParameter {
	return v.value
}

func (v *NullableReportVoucherSevQueryParameter) Set(val *ReportVoucherSevQueryParameter) {
	v.value = val
	v.isSet = true
}

func (v NullableReportVoucherSevQueryParameter) IsSet() bool {
	return v.isSet
}

func (v *NullableReportVoucherSevQueryParameter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportVoucherSevQueryParameter(val *ReportVoucherSevQueryParameter) *NullableReportVoucherSevQueryParameter {
	return &NullableReportVoucherSevQueryParameter{value: val, isSet: true}
}

func (v NullableReportVoucherSevQueryParameter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportVoucherSevQueryParameter) UnmarshalJSON(src []byte) error {
	v.isSet = true
