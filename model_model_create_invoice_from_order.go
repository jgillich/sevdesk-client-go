...
// checks if the ModelCreateInvoiceFromOrder type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelCreateInvoiceFromOrder{}

// ModelCreateInvoiceFromOrder Invoice model
type ModelCreateInvoiceFromOrder struct {
	Order ModelCreateInvoiceFromOrderOrder `json:"order"`
	...
	PartialType NullableString `json:"partialType,omitempty"`
}
...
func NewModelCreateInvoiceFromOrder(order ModelCreateInvoiceFromOrderOrder) *ModelCreateInvoiceFromOrder {
	this := ModelCreateInvoiceFromOrder{}
	this.Order = order
	return &this
}
...
func (o *ModelCreateInvoiceFromOrder) GetOrder() ModelCreateInvoiceFromOrderOrder {
	if o == nil {
		var ret ModelCreateInvoiceFromOrderOrder
		return ret
	}
...
func (o *ModelCreateInvoiceFromOrder) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o *ModelCreateInvoiceFromOrder) SetAmountNil() {
	o.Amount.Set(nil)
}
...
// GetPartialType returns the PartialType field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ModelCreateInvoiceFromOrder) GetPartialType() string {
	if o == nil || IsNil(o.PartialType.Get()) {
		var ret string
		return ret
	}
	return *o.PartialType.Get()
}

// GetPartialTypeOk returns a tuple with the PartialType field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetPartialType gets a reference to the given NullableString and assigns it to the PartialType field.
...
func (o *ModelCreateInvoiceFromOrder) SetPartialTypeNil() {
	o.PartialType.Set(nil)
}
...
func (o ModelCreateInvoiceFromOrder) MarshalJSON() ([]byte, error) {
...
func (o ModelCreateInvoiceFromOrder) ToMap() (map[string]interface{}, error) {
	...
	if o.PartialType.IsSet() {
		toSerialize["partialType"] = o.PartialType.Get()
	}
	return toSerialize, nil
}

type NullableModelCreateInvoiceFromOrder struct {
	value *ModelCreateInvoiceFromOrder
	isSet bool
}

func (v NullableModelCreateInvoiceFromOrder) Get() *ModelCreateInvoiceFromOrder {
	return v.value
}

func (v *NullableModelCreateInvoiceFromOrder) Set(val *ModelCreateInvoiceFromOrder) {
	v.value = val
	v.isSet = true
}

func (v NullableModelCreateInvoiceFromOrder) IsSet() bool {
	return v.isSet
}

func (v *NullableModelCreateInvoiceFromOrder) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelCreateInvoiceFromOrder(val *ModelCreateInvoiceFromOrder) *NullableModelCreateInvoiceFromOrder {
	return &NullableModelCreateInvoiceFromOrder{value: val, isSet: true}
}

func (v NullableModelCreateInvoiceFromOrder) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelCreateInvoiceFromOrder) UnmarshalJSON(src []byte) error {
	v.isSet = true
