...
// checks if the GetCommunicationWayKeys200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCommunicationWayKeys200Response{}

// GetCommunicationWayKeys200Response struct for GetCommunicationWayKeys200Response
type GetCommunicationWayKeys200Response struct {
...
func NewGetCommunicationWayKeys200Response() *GetCommunicationWayKeys200Response {
	this := GetCommunicationWayKeys200Response{}
	return &this
}
...
// GetUpadate returns the Upadate field value if set, zero value otherwise.
func (o *GetCommunicationWayKeys200Response) GetUpadate() time.Time {
	if o == nil || IsNil(o.Upadate) {
		var ret time.Time
		return ret
	}
	return *o.Upadate
...
// GetUpadateOk returns a tuple with the Upadate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GetCommunicationWayKeys200Response) GetUpadateOk() (*time.Time, bool) {
	if o == nil || IsNil(o.Upadate) {
		return nil, false
	}
	return o.Upadate, true
}
...
// SetUpadate gets a reference to the given time.Time and assigns it to the Upadate field.
...
// GetTranslationCode returns the TranslationCode field value if set, zero value otherwise.
func (o *GetCommunicationWayKeys200Response) GetTranslationCode() string {
	if o == nil || IsNil(o.TranslationCode) {
		var ret string
		return ret
	}
	return *o.TranslationCode
}

// GetTranslationCodeOk returns a tuple with the TranslationCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GetCommunicationWayKeys200Response) GetTranslationCodeOk() (*string, bool) {
	if o == nil || IsNil(o.TranslationCode) {
		return nil, false
	}
	return o.TranslationCode, true
}
...
// SetTranslationCode gets a reference to the given string and assigns it to the TranslationCode field.
func (o *GetCommunicationWayKeys200Response) SetTranslationCode(v string) {
	o.TranslationCode = &v
}

func (o GetCommunicationWayKeys200Response) MarshalJSON() ([]byte, error) {
...
func (o GetCommunicationWayKeys200Response) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Upadate) {
		toSerialize["upadate"] = o.Upadate
	}
	if !IsNil(o.Name) {
		toSerialize["name"] = o.Name
	}
	if !IsNil(o.TranslationCode) {
		toSerialize["translationCode"] = o.TranslationCode
	}
	return toSerialize, nil
}

type NullableGetCommunicationWayKeys200Response struct {
	value *GetCommunicationWayKeys200Response
	isSet bool
}

func (v NullableGetCommunicationWayKeys200Response) Get() *GetCommunicationWayKeys200Response {
	return v.value
}

func (v *NullableGetCommunicationWayKeys200Response) Set(val *GetCommunicationWayKeys200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCommunicationWayKeys200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCommunicationWayKeys200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCommunicationWayKeys200Response(val *GetCommunicationWayKeys200Response) *NullableGetCommunicationWayKeys200Response {
	return &NullableGetCommunicationWayKeys200Response{value: val, isSet: true}
}

func (v NullableGetCommunicationWayKeys200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCommunicationWayKeys200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
