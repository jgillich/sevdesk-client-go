...
// checks if the GetLetterpapersWithThumb200ResponseLetterpapers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetLetterpapersWithThumb200ResponseLetterpapers{}

// GetLetterpapersWithThumb200ResponseLetterpapers struct for GetLetterpapersWithThumb200ResponseLetterpapers
type GetLetterpapersWithThumb200ResponseLetterpapers struct {
...
func NewGetLetterpapersWithThumb200ResponseLetterpapers() *GetLetterpapersWithThumb200ResponseLetterpapers {
	this := GetLetterpapersWithThumb200ResponseLetterpapers{}
	return &this
}
...
func (o GetLetterpapersWithThumb200ResponseLetterpapers) MarshalJSON() ([]byte, error) {
...
func (o GetLetterpapersWithThumb200ResponseLetterpapers) ToMap() (map[string]interface{}, error) {
...
type NullableGetLetterpapersWithThumb200ResponseLetterpapers struct {
	value *GetLetterpapersWithThumb200ResponseLetterpapers
	isSet bool
}

func (v NullableGetLetterpapersWithThumb200ResponseLetterpapers) Get() *GetLetterpapersWithThumb200ResponseLetterpapers {
	return v.value
}

func (v *NullableGetLetterpapersWithThumb200ResponseLetterpapers) Set(val *GetLetterpapersWithThumb200ResponseLetterpapers) {
	v.value = val
	v.isSet = true
}

func (v NullableGetLetterpapersWithThumb200ResponseLetterpapers) IsSet() bool {
	return v.isSet
}

func (v *NullableGetLetterpapersWithThumb200ResponseLetterpapers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetLetterpapersWithThumb200ResponseLetterpapers(val *GetLetterpapersWithThumb200ResponseLetterpapers) *NullableGetLetterpapersWithThumb200ResponseLetterpapers {
	return &NullableGetLetterpapersWithThumb200ResponseLetterpapers{value: val, isSet: true}
}

func (v NullableGetLetterpapersWithThumb200ResponseLetterpapers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetLetterpapersWithThumb200ResponseLetterpapers) UnmarshalJSON(src []byte) error {
	v.isSet = true
