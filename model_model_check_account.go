...
// checks if the ModelCheckAccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelCheckAccount{}
...
type ModelCheckAccount struct {
	...
	SevClient *ModelCheckAccountSevClient `json:"sevClient,omitempty"`
	...
	DefaultAccount *int32 `json:"defaultAccount,omitempty"`
	...
	AutoMapTransactions NullableInt32 `json:"autoMapTransactions,omitempty"`
}
...
func NewModelCheckAccount(name string, type_ string, currency string, status int32) *ModelCheckAccount {
	this := ModelCheckAccount{}
	this.Name = name
	this.Type = type_
	this.Currency = currency
	var defaultAccount int32 = 0
	this.DefaultAccount = &defaultAccount
	this.Status = status
	var autoMapTransactions int32 = 1
	this.AutoMapTransactions = *NewNullableInt32(&autoMapTransactions)
	return &this
}
...
func (o *ModelCheckAccount) GetSevClient() ModelCheckAccountSevClient {
	if o == nil || IsNil(o.SevClient) {
		var ret ModelCheckAccountSevClient
		return ret
	}
	return *o.SevClient
}
...
// SetSevClient gets a reference to the given ModelCheckAccountSevClient and assigns it to the SevClient field.
...
func (o *ModelCheckAccount) SetImportTypeNil() {
...
// SetDefaultAccount gets a reference to the given int32 and assigns it to the DefaultAccount field.
...
// SetAutoMapTransactions gets a reference to the given NullableInt32 and assigns it to the AutoMapTransactions field.
...
func (o *ModelCheckAccount) SetAutoMapTransactionsNil() {
...
func (o ModelCheckAccount) MarshalJSON() ([]byte, error) {
...
func (o ModelCheckAccount) ToMap() (map[string]interface{}, error) {
...
type NullableModelCheckAccount struct {
	value *ModelCheckAccount
	isSet bool
}

func (v NullableModelCheckAccount) Get() *ModelCheckAccount {
	return v.value
}

func (v *NullableModelCheckAccount) Set(val *ModelCheckAccount) {
	v.value = val
	v.isSet = true
}

func (v NullableModelCheckAccount) IsSet() bool {
	return v.isSet
}

func (v *NullableModelCheckAccount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelCheckAccount(val *ModelCheckAccount) *NullableModelCheckAccount {
	return &NullableModelCheckAccount{value: val, isSet: true}
}

func (v NullableModelCheckAccount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelCheckAccount) UnmarshalJSON(src []byte) error {
	v.isSet = true
