...
// checks if the ModelCheckAccountResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelCheckAccountResponse{}
...
type ModelCheckAccountResponse struct {
	...
	SevClient *ModelCheckAccountResponseSevClient `json:"sevClient,omitempty"`
	...
	ImportType NullableString `json:"importType,omitempty"`
	...
	AutoMapTransactions NullableString `json:"autoMapTransactions,omitempty"`
}
...
func NewModelCheckAccountResponse() *ModelCheckAccountResponse {
	this := ModelCheckAccountResponse{}
	var defaultAccount string = "0"
	this.DefaultAccount = &defaultAccount
	var status string = "100"
	this.Status = &status
	var autoMapTransactions string = "1"
	this.AutoMapTransactions = *NewNullableString(&autoMapTransactions)
	return &this
}
...
func (o *ModelCheckAccountResponse) GetSevClient() ModelCheckAccountResponseSevClient {
	if o == nil || IsNil(o.SevClient) {
		var ret ModelCheckAccountResponseSevClient
		return ret
	}
	return *o.SevClient
}
...
// SetSevClient gets a reference to the given ModelCheckAccountResponseSevClient and assigns it to the SevClient field.
...
// SetImportType gets a reference to the given NullableString and assigns it to the ImportType field.
...
func (o *ModelCheckAccountResponse) SetImportTypeNil() {
...
// GetBankServer returns the BankServer field value if set, zero value otherwise.
func (o *ModelCheckAccountResponse) GetBankServer() string {
	if o == nil || IsNil(o.BankServer) {
		var ret string
		return ret
	}
	return *o.BankServer
...
// GetBankServerOk returns a tuple with the BankServer field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ModelCheckAccountResponse) GetBankServerOk() (*string, bool) {
	if o == nil || IsNil(o.BankServer) {
		return nil, false
	}
	return o.BankServer, true
}
...
// SetBankServer gets a reference to the given string and assigns it to the BankServer field.
func (o *ModelCheckAccountResponse) SetBankServer(v string) {
	o.BankServer = &v
}

// GetAutoMapTransactions returns the AutoMapTransactions field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ModelCheckAccountResponse) GetAutoMapTransactions() string {
	if o == nil || IsNil(o.AutoMapTransactions.Get()) {
		var ret string
		return ret
	}
	return *o.AutoMapTransactions.Get()
}

// GetAutoMapTransactionsOk returns a tuple with the AutoMapTransactions field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ModelCheckAccountResponse) GetAutoMapTransactionsOk() (*string, bool) {
	...
	return o.AutoMapTransactions.Get(), o.AutoMapTransactions.IsSet()
}
...
func (o *ModelCheckAccountResponse) HasAutoMapTransactions() bool {
	if o != nil && o.AutoMapTransactions.IsSet() {
		return true
	}
...
// SetAutoMapTransactions gets a reference to the given NullableString and assigns it to the AutoMapTransactions field.
func (o *ModelCheckAccountResponse) SetAutoMapTransactions(v string) {
	o.AutoMapTransactions.Set(&v)
}
// SetAutoMapTransactionsNil sets the value for AutoMapTransactions to be an explicit nil
func (o *ModelCheckAccountResponse) SetAutoMapTransactionsNil() {
	o.AutoMapTransactions.Set(nil)
}
...
func (o *ModelCheckAccountResponse) UnsetAutoMapTransactions() {
	o.AutoMapTransactions.Unset()
}

func (o ModelCheckAccountResponse) MarshalJSON() ([]byte, error) {
...
func (o ModelCheckAccountResponse) ToMap() (map[string]interface{}, error) {
	...
	// skip: bankServer is readOnly
	if o.AutoMapTransactions.IsSet() {
		toSerialize["autoMapTransactions"] = o.AutoMapTransactions.Get()
	}
	return toSerialize, nil
}

type NullableModelCheckAccountResponse struct {
	value *ModelCheckAccountResponse
	isSet bool
}

func (v NullableModelCheckAccountResponse) Get() *ModelCheckAccountResponse {
	return v.value
}

func (v *NullableModelCheckAccountResponse) Set(val *ModelCheckAccountResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableModelCheckAccountResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableModelCheckAccountResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelCheckAccountResponse(val *ModelCheckAccountResponse) *NullableModelCheckAccountResponse {
	return &NullableModelCheckAccountResponse{value: val, isSet: true}
}

func (v NullableModelCheckAccountResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelCheckAccountResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
