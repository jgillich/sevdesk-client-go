...
// checks if the ExportContactSevQueryParameter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExportContactSevQueryParameter{}

// ExportContactSevQueryParameter struct for ExportContactSevQueryParameter
type ExportContactSevQueryParameter struct {
	// Limit export
	...
	Filter *ReportContactSevQueryParameterFilter `json:"filter,omitempty"`
}
...
func NewExportContactSevQueryParameter(modelName interface{}, objectName interface{}) *ExportContactSevQueryParameter {
	this := ExportContactSevQueryParameter{}
...
func (o *ExportContactSevQueryParameter) GetFilter() ReportContactSevQueryParameterFilter {
	if o == nil || IsNil(o.Filter) {
		var ret ReportContactSevQueryParameterFilter
		return ret
	}
	return *o.Filter
}
...
// SetFilter gets a reference to the given ReportContactSevQueryParameterFilter and assigns it to the Filter field.
func (o *ExportContactSevQueryParameter) SetFilter(v ReportContactSevQueryParameterFilter) {
	o.Filter = &v
}

func (o ExportContactSevQueryParameter) MarshalJSON() ([]byte, error) {
...
func (o ExportContactSevQueryParameter) ToMap() (map[string]interface{}, error) {
...
type NullableExportContactSevQueryParameter struct {
	value *ExportContactSevQueryParameter
	isSet bool
}

func (v NullableExportContactSevQueryParameter) Get() *ExportContactSevQueryParameter {
	return v.value
}

func (v *NullableExportContactSevQueryParameter) Set(val *ExportContactSevQueryParameter) {
	v.value = val
	v.isSet = true
}

func (v NullableExportContactSevQueryParameter) IsSet() bool {
	return v.isSet
}

func (v *NullableExportContactSevQueryParameter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportContactSevQueryParameter(val *ExportContactSevQueryParameter) *NullableExportContactSevQueryParameter {
	return &NullableExportContactSevQueryParameter{value: val, isSet: true}
}

func (v NullableExportContactSevQueryParameter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportContactSevQueryParameter) UnmarshalJSON(src []byte) error {
	v.isSet = true
