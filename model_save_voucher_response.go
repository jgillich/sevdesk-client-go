...
// checks if the SaveVoucherResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SaveVoucherResponse{}

// SaveVoucherResponse struct for SaveVoucherResponse
...
// SetVoucher gets a reference to the given ModelVoucherResponse and assigns it to the Voucher field.
...
func (o *SaveVoucherResponse) GetVoucherPos() ModelVoucherPosResponse {
	if o == nil || IsNil(o.VoucherPos) {
		var ret ModelVoucherPosResponse
		return ret
	}
	return *o.VoucherPos
}
...
// SetVoucherPos gets a reference to the given ModelVoucherPosResponse and assigns it to the VoucherPos field.
...
func (o SaveVoucherResponse) MarshalJSON() ([]byte, error) {
...
func (o SaveVoucherResponse) ToMap() (map[string]interface{}, error) {
...
type NullableSaveVoucherResponse struct {
	value *SaveVoucherResponse
	isSet bool
}

func (v NullableSaveVoucherResponse) Get() *SaveVoucherResponse {
	return v.value
}

func (v *NullableSaveVoucherResponse) Set(val *SaveVoucherResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSaveVoucherResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSaveVoucherResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSaveVoucherResponse(val *SaveVoucherResponse) *NullableSaveVoucherResponse {
	return &NullableSaveVoucherResponse{value: val, isSet: true}
}

func (v NullableSaveVoucherResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSaveVoucherResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
