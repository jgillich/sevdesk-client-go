...
// checks if the ReportContactSevQueryParameterFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportContactSevQueryParameterFilter{}

// ReportContactSevQueryParameterFilter struct for ReportContactSevQueryParameterFilter
type ReportContactSevQueryParameterFilter struct {
	// filters the contacts by zip code
	Zip *int32 `json:"zip,omitempty"`
	// filters the contacts by city
	City *string `json:"city,omitempty"`
	Country *ReportContactSevQueryParameterFilterCountry `json:"country,omitempty"`
...
func NewReportContactSevQueryParameterFilter() *ReportContactSevQueryParameterFilter {
	this := ReportContactSevQueryParameterFilter{}
	return &this
}
...
// SetZip gets a reference to the given int32 and assigns it to the Zip field.
...
func (o *ReportContactSevQueryParameterFilter) GetCountry() ReportContactSevQueryParameterFilterCountry {
	if o == nil || IsNil(o.Country) {
		var ret ReportContactSevQueryParameterFilterCountry
		return ret
	}
	return *o.Country
}
...
// SetCountry gets a reference to the given ReportContactSevQueryParameterFilterCountry and assigns it to the Country field.
...
// SetDepth gets a reference to the given bool and assigns it to the Depth field.
func (o *ReportContactSevQueryParameterFilter) SetDepth(v bool) {
	o.Depth = &v
}

// GetOnlyPeople returns the OnlyPeople field value if set, zero value otherwise.
func (o *ReportContactSevQueryParameterFilter) GetOnlyPeople() bool {
	if o == nil || IsNil(o.OnlyPeople) {
		var ret bool
		return ret
	}
	return *o.OnlyPeople
...
// GetOnlyPeopleOk returns a tuple with the OnlyPeople field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReportContactSevQueryParameterFilter) GetOnlyPeopleOk() (*bool, bool) {
	if o == nil || IsNil(o.OnlyPeople) {
		return nil, false
	}
	return o.OnlyPeople, true
}
...
// SetOnlyPeople gets a reference to the given bool and assigns it to the OnlyPeople field.
func (o *ReportContactSevQueryParameterFilter) SetOnlyPeople(v bool) {
	o.OnlyPeople = &v
}

func (o ReportContactSevQueryParameterFilter) MarshalJSON() ([]byte, error) {
...
func (o ReportContactSevQueryParameterFilter) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OnlyPeople) {
		toSerialize["onlyPeople"] = o.OnlyPeople
	}
	return toSerialize, nil
}

type NullableReportContactSevQueryParameterFilter struct {
	value *ReportContactSevQueryParameterFilter
	isSet bool
}

func (v NullableReportContactSevQueryParameterFilter) Get() *ReportContactSevQueryParameterFilter {
	return v.value
}

func (v *NullableReportContactSevQueryParameterFilter) Set(val *ReportContactSevQueryParameterFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableReportContactSevQueryParameterFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableReportContactSevQueryParameterFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportContactSevQueryParameterFilter(val *ReportContactSevQueryParameterFilter) *NullableReportContactSevQueryParameterFilter {
	return &NullableReportContactSevQueryParameterFilter{value: val, isSet: true}
}

func (v NullableReportContactSevQueryParameterFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportContactSevQueryParameterFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
